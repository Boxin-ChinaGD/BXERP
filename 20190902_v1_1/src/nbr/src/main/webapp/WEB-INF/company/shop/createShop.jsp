...
<head>
	...
	<link type="text/css" rel="stylesheet" href="css/bx_createShop.css" />
	<title>门店列表</title>
</head>
...
<!-- 			</div> -->
			...
			<div class="shopInformation layui-form" lay-filter="shopInformation">
				<h3>门店信息</h3>
				<button class="createShop">保存</button>
				<button class="cancel">取消</button>
<%-- 				<input type="hidden" name="${shop.FIELD_NAME_companyID}" class="companyID" /> --%>
<%-- 				<input type="hidden" name="${shop.FIELD_NAME_ID}" class="shopID" /> --%>
				<table>
					<tbody>
<!-- 						<tr> -->
<!-- 							<td>业务员</td> -->
...
<!-- 									autocomplete="off"  unselectable="on" /> -->
<!-- 							</td> -->
<!-- 						</tr> -->
						<tr>
							<td>门店名称</td>
							<td class="message shopName">
								<input type="text" name="${shop.FIELD_NAME_name}" id="${shop.FIELD_NAME_name}" value="" lay-verify="required"
									autocomplete="off"  unselectable="on" />
							</td>
						</tr>
<!-- 						<tr> -->
...
<%-- 								<input type="text" name="${shop.FIELD_NAME_status}" id="${shop.FIELD_NAME_status}" class="shopStatus" value="" --%>
<!-- 									lay-verify="required" autocomplete="off"  unselectable="on" /> -->
<!-- 							</td> -->
<!-- 						</tr> -->
						<tr>
							<td>地址</td>
							<td class="message site">
								<input type="text" name="${shop.FIELD_NAME_address}" id="${shop.FIELD_NAME_address}" value="" lay-verify="required"
									autocomplete="off"  unselectable="on" />
							</td>
						</tr>
						<tr>
							...
							<td class="message longitudeAndLatitude">
								<input type="text" name="${shop.FIELD_NAME_longitude}" id="${shop.FIELD_NAME_longitude}" value="" lay-verify="required"
									autocomplete="off"  unselectable="on" />
							</td>
						</tr>
						<tr>
							<td>维度</td>
							<td class="message">
								<input type="text" name="${shop.FIELD_NAME_latitude}" id="${shop.FIELD_NAME_latitude}" value="" lay-verify="required"
									autocomplete="off"  unselectable="on" />
							</td>
						</tr>
						<tr>
							...
							<td class="message remark">
								<input type="text" name="${shop.FIELD_NAME_remark}" id="${shop.FIELD_NAME_remark}" value="" lay-verify="required"
									autocomplete="off"  unselectable="on" />
							</td>
						</tr>
<!-- 						<tr> -->
<!-- 							<td>钥匙</td> -->
<!-- 							<td class="message remark"> -->
<%-- 								<input type="text" name="${shop.FIELD_NAME_key}" id="${shop.FIELD_NAME_remark}" value="" lay-verify="required" --%>
<!-- 									autocomplete="off"  unselectable="on" /> -->
<!-- 							</td> -->
<!-- 						</tr> -->
						<tr>
...
<!-- 									autocomplete="off"  unselectable="on" /> -->
								<select name="${shop.FIELD_NAME_companyID}" id="${shop.FIELD_NAME_companyID}" lay-verify="required">
									<c:forEach items="${companyList}" var="cpl">
										<option value="${cpl.ID}">${cpl.name}</option>
									</c:forEach>
								</select>
							</td>
						</tr>
				...
				<input type="hidden" lay-submit lay-filter="shopsubmit" class="shopsubmit" id = "shopInformation">
			</div>
			<!-- pos机信息 -->
...
<!-- 	<script type="text/javascript" charset="utf-8" src="scripts/bx_sessionValidityPeriodTesting.js"></script> -->
	<script type="text/javascript" charset="utf-8" src="scripts/bx_createShop.js"></script>
