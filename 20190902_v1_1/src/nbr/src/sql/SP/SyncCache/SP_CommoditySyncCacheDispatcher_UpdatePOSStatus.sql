DROP PROCEDURE IF EXISTS `SP_CommoditySyncCacheDispatcher_UpdatePOSStatus`;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_CommoditySyncCacheDispatcher_UpdatePOSStatus`(
	OUT iErrorCode INT,
