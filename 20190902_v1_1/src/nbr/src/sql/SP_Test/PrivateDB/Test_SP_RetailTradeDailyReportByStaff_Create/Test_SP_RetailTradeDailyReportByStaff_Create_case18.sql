SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case18.sql+++++++++++++++++++++++';

SELECT '----- case18:员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应两个入库单 , C商品，对应一个入库单[A]-------' AS 'Case18';
-- 
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification1 = 1,'测试成功','测试失败') AS 'Test Case18 Result';
-- 
