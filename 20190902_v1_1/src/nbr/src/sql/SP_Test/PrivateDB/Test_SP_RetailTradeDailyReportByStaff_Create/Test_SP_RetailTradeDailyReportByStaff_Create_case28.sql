SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case28.sql+++++++++++++++++++++++';


SELECT '----- case28:员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应两个入库单 , C商品，对应两个入库单,A隔天创建一张退货单，对商品A、B部分退货, [A、A]-------' AS 'Case28';
-- 收银员
SET @staffID_A = 9;
...
SET @warehousingCommodityA_Price1 = 9.33299; -- 入库单1
SET @warehousingCommodityA_NO1 = 500;
SET @warehousingCommodityA_Price2 = 8.8543; -- 入库单2
SET @warehousingCommodityA_NO2 = 1000;
SET @commodityPriceB = 220;
SET @warehousingCommodityB_Price1 = 7.73477;
SET @warehousingCommodityB_NO1 = 500;
SET @warehousingCommodityB_Price2 = 6.669936;
SET @warehousingCommodityB_NO2 = 1000;
SET @commodityPriceC = 770;
SET @warehousingCommodityC_Price1 = 5.523555;
SET @warehousingCommodityC_NO1 = 500;
SET @warehousingCommodityC_Price2 = 4.44536;
...
SET @rrt1CommotidyNO2_A = @rt1CommotidyNO1Yesterday_A; -- 入库单2
SET @rrt1CommotidyNO2_B = @rt1CommotidyNO1Yesterday_B;
