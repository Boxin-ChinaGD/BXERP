SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case29.sql+++++++++++++++++++++++';


SELECT '----- case29:员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应两个入库单 , C商品，对应两个入库单,员工B隔天创建一张退货单，对商品A、B全部退货[AB]-------' AS 'Case29';
-- 收银员
SET @staffID_A = 9;
SET @staffID_B = 10;
...
SET @warehousingCommodityA_Price1 = 9.2312; -- 入库单1
SET @warehousingCommodityA_NO1 = 500;
SET @warehousingCommodityA_Price2 = 8.45358; -- 入库单2
SET @warehousingCommodityA_NO2 = 1000;
SET @commodityPriceB = 220;
SET @warehousingCommodityB_Price1 = 7.6627;
SET @warehousingCommodityB_NO1 = 500;
SET @warehousingCommodityB_Price2 = 6.662366;
SET @warehousingCommodityB_NO2 = 1000;
SET @commodityPriceC = 770;
SET @warehousingCommodityC_Price1 = 5.55455;
SET @warehousingCommodityC_NO1 = 500;
SET @warehousingCommodityC_Price2 = 4.443344;
...
SET @rrt1TotalAmount_A = (@rrt1CommotidyNO1_A + @rrt1CommotidyNO2_A) * @rt1CommotidyPriceYesterday_A + (@rrt1CommotidyNO1_B + @rrt1CommotidyNO2_B) * @rt1CommotidyPriceYesterday_B; -- 退货总额
...
SET @returnGrossMargin = (@rrt1CommotidyNO2_A * @warehousingCommodityA_Price2) + (@rrt1CommotidyNO1_A * @warehousingCommodityA_Price1) -- 
