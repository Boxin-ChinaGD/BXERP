SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case46.sql+++++++++++++++++++++++';


SELECT '----- case46:员工A创建一个零售单卖A商品，对应两个入库单(一次入库价位15，一次为10) ,B商品，对应一个入库单 , C商品，对应一个入库单,创建一张退货单，对商品A全部退货,对B部分退货,上午卖，下午退 [A、A]-------' AS 'Case46';
...
-- 插入入库单商品表
SET @warehouseA1NO = 310;
SET @warehouseA2NO = 400;
...
-- 插入入库单商品表
SET @warehouseB1NO = 219;
SET @warehouseB1Price = 22.760000;
INSERT INTO t_warehousingcommodity (F_WarehousingID, F_CommodityID, F_NO, F_PackageUnitID, F_CommodityName, F_BarcodeID, F_Price, F_Amount, F_ProductionDatetime, F_ShelfLife, F_ExpireDatetime, F_CreateDatetime, F_UpdateDatetime, F_NOSalable)
...
SET @returnCommBNO_A = 111; -- 部分退,总200
...
SET @saleDatetime2_A = '2041/02/02 15:00:01';
SET @syncDatetime2_A = '2041/02/02 15:01:01';
...
SET @rggWorkTimeStart1='2041/02/02 08:00:00';
SET @rggWorkTimeEnd1='2041/02/02 12:00:00';
SET @rggNO_A = 1;
-- 
...
VALUES (@staffIDA, 2, @rggWorkTimeStart1, @rggWorkTimeEnd1, @rggNO_A, @rggTotalAmount_A1, 4000.000000, @rggTotalAmountCash_A1, @rggTotalAmountWeChat_A1, @rggTotalAmountAliPay_A1, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, now());
SET @rtgIDA1 = last_insert_id();
-- 
SET @rggTotalAmount_A2 = @rrtTotalAmount_A;
SET @rggTotalAmountCash_A2 = @rrtAmuontCash_A;
SET @rggTotalAmountWeChat_A2 = @rrtAmuontWeChat_A;
SET @rggTotalAmountAliPay_A2 = @rrtAmuontAliPay_A;
SET @rggWorkTimeStart2='2041/02/02 14:00:00';
SET @rggWorkTimeEnd2='2041/02/02 23:59:59';
SET @rggNO_A2 = 0;
INSERT INTO t_retailtradeaggregation (F_StaffID, F_PosID, F_WorkTimeStart, F_WorkTimeEnd, F_TradeNO, F_Amount, F_ReserveAmount, F_CashAmount, F_WechatAmount, F_AlipayAmount, F_Amount1, F_Amount2, F_Amount3, F_Amount4, F_Amount5, F_UploadDateTime)
VALUES (@staffIDA, 2, @rggWorkTimeStart2, @rggWorkTimeEnd2, @rggNO_A2, @rggTotalAmount_A2, 1600.000000, @rggTotalAmountCash_A2, @rggTotalAmountWeChat_A2,@rggTotalAmountAliPay_A2, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, now());
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification_A = 1,'测试成功','测试失败') AS 'Test Case46 Result';
-- 
