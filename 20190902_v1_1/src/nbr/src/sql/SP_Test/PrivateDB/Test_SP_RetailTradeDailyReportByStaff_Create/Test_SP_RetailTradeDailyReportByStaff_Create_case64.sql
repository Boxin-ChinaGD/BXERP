SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case64.sql+++++++++++++++++++++++';

SELECT '----- case64: 员工A创建一个零售单卖A一个商品，商品A为未入库商品,创建一个退货单，对商品A进行全部退货 -------' AS 'Case64';
...
SET @rt1ReturnAmuontCash = 100.00000;
...
VALUES (1,'LS2119011501010100011244', 2,1,'url=ashasoadigmnalskd',@saleDatetime,@iStaffID,1,0,1,'........',@syncDatetime,@rt1TotalAmount,@rt1ReturnAmuontCash,@rt1ReturnAmuontWeChat,@rt1ReturnAmuontAliPay,0,0,0,0,0,1,@rtID1,2);
...
SELECT IF(@saleTotalCost = 0,'测试成功','测试失败') AS 'Test Case1 Result';
-- 售卖商品总毛利
...
SELECT IF(@grossMargin = 0,'测试成功','测试失败') AS 'Test Case1 Result';
