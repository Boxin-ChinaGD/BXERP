...
SELECT '----- case72:  员工A卖A商品，商品A为未入库商品 ,卖B商品，对应一个入库单，对A部分退货，对商品B全部退货 [A] -------' AS 'Case72';
-- 
--  员工ID
SET @staffIDA = 9;
...
-- 员工A新建退货单
SET @returnCommANO_A = 250; -- 卖500个，退250个
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification_A = 1,'测试成功','测试失败') AS 'Test Case72 Result';
-- 
