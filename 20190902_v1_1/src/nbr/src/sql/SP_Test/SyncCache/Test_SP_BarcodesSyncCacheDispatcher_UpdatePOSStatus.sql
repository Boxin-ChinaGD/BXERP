SELECT '++++++++++++++++++Test_SP_BarcodesSyncCacheDispatcher_UpdatePOSStatus.sql+++++++++++++++++++++++';

SELECT '-----------------Case1: 正常添加------------------' AS 'Case1';

INSERT INTO t_barcodessynccache (F_SyncData_ID, F_SyncType, F_SyncSequence) VALUES (1,'C',3);
SET @iSyncCacheID = last_insert_id();
SET @iErrorCode = 0;
SET @sErrorMsg = '';
SET @iPOS_ID = 3;

CALL SP_BarcodesSyncCacheDispatcher_UpdatePOSStatus(@iErrorCode, @sErrorMsg, @iSyncCacheID, @iPOS_ID);
