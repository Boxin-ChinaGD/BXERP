...
import java.util.*;
public class UTR14queryHistory2Test {
  ...
  @Test
  public void uTR14queryHistory2() {
    LoginSucceed();
    ...
    driver.findElement(By.name("queryKeyword")).click();
    driver.findElement(By.name("queryKeyword")).sendKeys("可乐……");
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("数据格式不正确，请输入中英文、数字，只允许中间有空格，支持输入的符号有：（）()_-——"));
    driver.findElement(By.name("queryKeyword")).click();
    driver.findElement(By.name("queryKeyword")).sendKeys("你hao");
    driver.findElement(By.cssSelector(".layui-icon")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("查无商品修改记录"));
    driver.findElement(By.name("queryKeyword")).click();
    driver.findElement(By.name("queryKeyword")).sendKeys("你      ");
    driver.findElement(By.cssSelector(".layui-icon")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("查无商品修改记录"));
    driver.close();
  }
