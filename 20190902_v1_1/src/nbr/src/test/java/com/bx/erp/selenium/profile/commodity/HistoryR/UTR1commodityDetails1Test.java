...
import java.util.*;
public class UTR1commodityDetails1Test {
  ...
  @Test
  public void uTR1commodityDetails1() {
    LoginSucceed();
...
//    System.out.println("商品修改记录条数为：vars.get("historyCount").toString()");
    ...
    vars.put("commodityName", js.executeScript("return \"神龙摆尾\" + parseInt(Math.random()*1000);"));
    ...
    // TODO
//    System.out.println("创建的商品名称为：vars.get("commodityName").toString()");
