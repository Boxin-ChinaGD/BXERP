...
import java.util.*;
public class UTcommodityC16checkPriceWholesale1Test {
  ...
  @Test
  public void uTcommodityC16checkPriceWholesale1() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".generalCommodityInfo > .layui-form-item:nth-child(13) > .layui-inline:nth-child(2)")).click();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("格式错误，请输入非负数字，允许有两位小数"));
    driver.findElement(By.cssSelector(".generalCommodityInfo > .layui-form-item:nth-child(13)")).click();
