...
import java.util.*;
public class UTcommodityC24checkProeprtyValue1Test {
  ...
  @Test
  public void uTcommodityC24checkProeprtyValue1() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("属性值长度[0, 50]"));
  }
}
