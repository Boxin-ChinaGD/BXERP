...
import java.util.*;
public class UTcommodityC37checkStartValueRemark2Test {
  ...
  @Test
  public void uTcommodityC37checkStartValueRemark2() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is(not("期初值备注长度[0, 50]")));
