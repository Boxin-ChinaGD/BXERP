...
import java.util.*;
public class UTcommodityC46createCommodity9Test {
  ...
  @Test
  public void uTcommodityC46createCommodity9() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".layui-form-item:nth-child(12) > .layui-inline:nth-child(2) > .layui-input-inline")).click();
    driver.findElement(By.name("priceVIP")).sendKeys("66");
    driver.findElement(By.cssSelector(".generalCommodityInfo > .layui-form-item:nth-child(13) > .layui-inline:nth-child(2) > .layui-input-inline")).click();
