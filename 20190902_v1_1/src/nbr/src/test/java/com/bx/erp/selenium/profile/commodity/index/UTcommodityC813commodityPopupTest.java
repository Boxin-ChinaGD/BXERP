...
import java.util.*;
public class UTcommodityC813commodityPopupTest {
  ...
  @Test
  public void uTcommodityC813commodityPopup() {
    LoginSucceed();
...
//    System.out.println("商品条数为：vars.get("count").toString()");
    ...
    driver.findElement(By.cssSelector(".layui-form-item:nth-child(27) .layui-edge")).click();
...
//    System.out.println("此时查到的商品条数应为：vars.get("count").toString()");
    ...
    driver.findElement(By.cssSelector(".layui-nav-item:nth-child(13) .layui-this > a")).click();
    assertThat(driver.findElement(By.cssSelector("#popupCommodityList + div .layui-laypage-count")).getText(), is("vars.get(\"count\").toString()"));
  }
}
