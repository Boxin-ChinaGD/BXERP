...
import java.util.*;
public class UTcommodityD11deleteCommodityBarcode3Test {
  ...
  @Test
  public void uTcommodityD11deleteCommodityBarcode3() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".toAddBarcode")).click();
    driver.findElement(By.cssSelector(".layui-form-item:nth-child(11) > .layui-icon")).click();
    driver.findElement(By.cssSelector(".otherBarcode > .layui-icon")).click();
  }
}
