...
import java.util.*;
public class UTcommodityD2deleteCommodity2Test {
  ...
  @Test
  public void uTcommodityD2deleteCommodity2() {
    LoginSucceed();
    ...
    driver.findElement(By.linkText("确定")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("该商品有盘点单依赖，不能删除"));
  }
}
