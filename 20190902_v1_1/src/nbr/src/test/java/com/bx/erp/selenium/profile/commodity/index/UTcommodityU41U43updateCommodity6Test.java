...
import java.util.*;
public class UTcommodityU41U43updateCommodity6Test {
  ...
  @Test
  public void uTcommodityU41U43updateCommodity6() {
    LoginSucceed();
    ...
    driver.findElement(By.name("priceRetail")).click();
    driver.findElement(By.name("priceRetail")).sendKeys("20.00");
    ...
    driver.findElement(By.cssSelector(".commodityInfo")).click();
    {
      String value = driver.findElement(By.cssSelector(".multiPackagePriceVIP > td:nth-child(3) > .layui-input")).getAttribute("value");
    ...
    driver.findElement(By.cssSelector(".commodityInfo")).click();
    {
      String value = driver.findElement(By.cssSelector(".multiPackagePriceWholesale > td:nth-child(3) > .layui-input")).getAttribute("value");
