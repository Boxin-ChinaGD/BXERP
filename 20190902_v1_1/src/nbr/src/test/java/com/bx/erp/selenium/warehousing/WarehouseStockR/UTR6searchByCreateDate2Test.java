...
import java.util.*;
public class UTR6searchByCreateDate2Test {
  ...
  @Test
  public void uTR6searchByCreateDate2() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.xpath("//ul[@id=\'timeList\']/li[2]")).getText(), is("过去一周内"));
    driver.findElement(By.xpath("//ul[@id=\'timeList\']/li[2]")).click();
