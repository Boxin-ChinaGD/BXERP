...
import java.util.*;
public class UTR7searchByCreateDate3Test {
  ...
  @Test
  public void uTR7searchByCreateDate3() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.xpath("//ul[@id=\'timeList\']/li[3]")).getText(), is("过去一月内"));
    driver.findElement(By.xpath("//ul[@id=\'timeList\']/li[3]")).click();
