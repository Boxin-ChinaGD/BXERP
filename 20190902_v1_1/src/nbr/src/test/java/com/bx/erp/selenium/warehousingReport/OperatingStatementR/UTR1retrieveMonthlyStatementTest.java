...
import java.util.*;
public class UTR1retrieveMonthlyStatementTest {
  ...
  @Test
  public void uTR1retrieveMonthlyStatement() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".default")).getText(), is("月报"));
    driver.close();
  }
}
