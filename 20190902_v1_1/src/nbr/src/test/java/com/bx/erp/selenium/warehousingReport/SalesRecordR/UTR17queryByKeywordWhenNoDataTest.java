...
import java.util.*;
public class UTR17queryByKeywordWhenNoDataTest {
  ...
  @Test
  public void uTR17queryByKeywordWhenNoData() {
    LoginSucceed();
...
//    System.out.println("销售记录的条数为：vars.get("counts").toString()");
    ...
    driver.findElement(By.cssSelector(".top_input")).sendKeys("AAAAAaaaa");
    driver.findElement(By.cssSelector(".layui-icon")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-none")).getText(), is("无数据"));
    if ((Boolean) js.executeScript("return (document.getElementsByClassName(\'layui-none\')[0].innerHTML == \'无数据\')")) {
