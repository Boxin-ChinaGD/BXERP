...
import com.bx.erp.http.request.PosGetToken;
import com.bx.erp.http.request.PosLogin;
...
public class PosLoginHttpBO extends LoginHttpBO {
    ...
    public PosLoginHttpBO(Context ctx, BaseSQLiteEvent sEvent, BaseHttpEvent hEvent) {
