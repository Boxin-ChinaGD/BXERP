...
import com.bx.erp.http.request.CreateNRetailTradePromoting;
import com.bx.erp.http.request.CreateRetailTradePromoting;
...
public class RetailTradePromotingHttpBO extends BaseHttpBO {
    ...
    public RetailTradePromotingHttpBO(Context ctx, BaseSQLiteEvent sEvent, BaseHttpEvent hEvent) {
        context = ctx;
        sqLiteEvent = sEvent;
        httpEvent = hEvent;
    }
