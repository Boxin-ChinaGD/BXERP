...
@Entity(nameInDb = "commodityCategory")
public class CommodityCategory extends BaseModel {
    ...
    public List<BaseModel> parseN(JSONArray jsonArray1) {
        System.out.println("正在执行CommodotyCategory的parseN，jsonArray1=" + (jsonArray1 == null ? null : jsonArray1.toString()));
