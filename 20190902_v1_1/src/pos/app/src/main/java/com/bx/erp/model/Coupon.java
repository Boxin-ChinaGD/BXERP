...
public class Coupon extends BaseModel {
    ...
    @Property(nameInDb = "F_LeastAmount")
    @NotNull
    protected double leastAmount;

    @Property(nameInDb = "F_ReduceAmount")
    @NotNull
    protected double reduceAmount;

    @Property(nameInDb = "F_Discount")
    @NotNull
    protected double discount;

    @Property(nameInDb = "F_Title")
    @NotNull
    protected String title;

    @Property(nameInDb = "F_Color")
    @NotNull
    protected String color;

    @Property(nameInDb = "F_Description")
    @NotNull
    protected String description;

    @Property(nameInDb = "F_PersonalLimit")
    @NotNull
    protected int personalLimit;

    @Property(nameInDb = "F_WeekDayAvailable")
    protected int weekDayAvailable;

    @Property(nameInDb = "F_BeginTime")
    @NotNull
    protected String beginTime;

    @Property(nameInDb = "F_EndTime")
    @NotNull
    protected String endTime;

    @Property(nameInDb = "F_BeginDateTime")
    @NotNull
    ...
    @Property(nameInDb = "F_Quantity")
    @NotNull
    protected int quantity;

    @Property(nameInDb = "F_RemainingQuantity")
    @NotNull
