...
public class StaffField extends BaseAuthenticationModelField {
    ...
    protected String FIELD_NAME_newPwdEncrypted;

    public String getFIELD_NAME_newPwdEncrypted() {
        return "sPasswordEncryptedNew";
    }

    protected String FIELD_NAME_oldPwdEncrypted;

    public String getFIELD_NAME_oldPwdEncrypted() {
        return "sPasswordEncryptedOld";
    }
}
