...
//                break;
//            case R.id.change_shifts: //打印交班表，并且上传收银汇总信息到服务器（等待UI）,查询本地SQLite中有没有临时零售单，退出登录，完成之后回到登录界面
...
//                                        log.info("上传临时零售单同步数据失败！原因：超时！");
//                                    }
//
//                                    //将当前时间设为零售汇总的下班时间,上传更新的收银汇总到服务器
//                                    log.info("交班，上传的收银汇总=" + BaseActivity.retailTradeAggregation);
