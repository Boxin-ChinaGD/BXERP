...
public class CommodityRecyclerViewAdapter1 extends RecyclerView.Adapter<CommodityRecyclerViewAdapter1.MyViewHolder> {
    List<Commodity> list;
    Context context;
    ...
    public CommodityRecyclerViewAdapter1(List<Commodity> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.commodity_rv_item1, parent, false));
        return holder;
    }
