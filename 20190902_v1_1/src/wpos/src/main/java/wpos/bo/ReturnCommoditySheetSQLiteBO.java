...
//
//public class ReturnCommoditySheetSQLiteBO extends BaseSQLiteBO {
//    public ReturnCommoditySheetSQLiteBO(Context ctx, BaseSQLiteEvent sEvent, BaseHttpEvent hEvent) {
//        context = ctx;
//        sqLiteEvent = sEvent;
//        httpEvent = hEvent;
//    }
