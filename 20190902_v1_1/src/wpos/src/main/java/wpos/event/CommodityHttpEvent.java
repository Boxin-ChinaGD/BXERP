        ...
        try {
            ...
            if (commodityArray.size() <= 0) {
                ...
                for (int i = 0; i < commodityArray.size(); i++) {
                    ...
                    commodity.setID(commObject.getInteger(commodity.field.getFIELD_NAME_ID()));
                    commodity.setNO(commObject.getInteger(commodity.field.getFIELD_NAME_NO()));
