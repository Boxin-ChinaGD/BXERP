...
public class BaseModelField {
    ...
    public String FIELD_NAME_TOLERANCE;

    public String getFIELD_NAME_TOLERANCE() {
        return "TOLERANCE";
    }

    public String FIELD_NAME_ignoreIDInComparision;

    public String getFIELD_NAME_ignoreIDInComparision() {
        return "ignoreIDInComparision";
    }

    public String FIELD_NAME_conditions;

    public String getFIELD_NAME_conditions() {
        return "conditions";
    }

    public String FIELD_NAME_sql;

    public String getFIELD_NAME_sql() {
        return "sql";
    }
