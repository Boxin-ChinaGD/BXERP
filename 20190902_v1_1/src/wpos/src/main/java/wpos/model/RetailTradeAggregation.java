...
@Entity
@Table(name = "T_RetailTradeAggregation")
...
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    //@NotNull
    @Column(name = "F_WorkTimeStart")
    private Date workTimeStart;

    @Column(name = "F_WorkTimeEnd")
    private Date workTimeEnd;

    //@NotNull
    @Column(name = "F_TradeNO")
    private int tradeNO;
    ...
    //@NotNull
    @Column(name = "F_ReserveAmount")
    private double reserveAmount;

    @Column(name = "F_CashAmount")
    private double cashAmount;

    @Column(name = "F_WechatAmount")
    private double wechatAmount;

    @Column(name = "F_AlipayAmount")
...
//    }
    ...
    protected BaseModel doParse1(JSONObject jo) {
        ...
        try {
            ...
            posID = jo.getInteger(field.getFIELD_NAME_posID());
            tradeNO = jo.getInteger(field.getFIELD_NAME_tradeNO());
