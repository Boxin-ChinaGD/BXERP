...
@Entity
@Table(name = "T_RetailTradeCommodity")
...
//    }
    ...
    public List<BaseModel> parseN(String s) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.toArray().length; i++) {
                JSONObject jsonObject1 = (JSONObject)jsonArray.toArray()[i];
    ...
    public BaseModel clone() {
        ...
        rtc.setCommodityName(this.getCommodityName());
    ...
    public int compareTo(final BaseModel arg0) {
        ...
        if ((ignoreIDInComparision == true ? true
                : rtc.getID().intValue() == ID.intValue() && printComparator(field.getFIELD_NAME_ID()) //
                && rtc.getTradeID().longValue() == tradeID.longValue() && printComparator(field.getFIELD_NAME_tradeID())) //
