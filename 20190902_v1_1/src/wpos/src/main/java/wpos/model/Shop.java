...
//    }
    ...
    public BaseModel doParse1(JSONObject object) {
        ...
        try {
            ...
            bxStaffID = object.getInteger(field.getFIELD_NAME_bxStaffID());
            remark = object.getString(field.getFIELD_NAME_remark());
            districtID = object.getInteger(field.getFIELD_NAME_districtID());
            ...
            latitude = object.getInteger(field.getFIELD_NAME_latitude());
            longitude = object.getInteger(field.getFIELD_NAME_longitude());
