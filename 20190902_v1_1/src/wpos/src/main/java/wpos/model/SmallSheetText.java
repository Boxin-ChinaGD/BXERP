...
//    public final static String payment_Method2 = "payment_method2";
    ...
    @Column(name = "F_Gravity")
    protected int gravity;

    @Column(name = "F_FrameID")
...
//    }
    ...
    public BaseModel doParse1(JSONObject object) {
        ...
        try {
            ...
            bold = object.getInteger(field.getFIELD_NAME_bold());
            content = object.getString(field.getFIELD_NAME_content());
            gravity = object.getInteger(field.getFIELD_NAME_gravity());
            size = object.getInteger(field.getFIELD_NAME_size());
            //
    ...
    public List<?> parseN(JSONArray jsonArray) {
        ...
        List<BaseModel> smallSheetTextList = new ArrayList<BaseModel>();
        try {
    ...
    public enum EnumSmallSheetTextGravity {
        LEFT("TOP_LEFT", 51),
        CENTER("CENTER", 17),
        RIGHT("TOP_RIGHT", 53);
        ...
        private EnumSmallSheetTextGravity(String name, int index) {
            this.name = name;
            this.index = index;
        }

        public static int getIndex(String name){
            for (EnumSmallSheetTextGravity esst : values()){
