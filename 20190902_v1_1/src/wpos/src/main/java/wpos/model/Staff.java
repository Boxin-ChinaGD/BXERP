...
public class Staff extends BaseAuthenticationModel {
    ...
    @Column(name = "F_PasswordExpireDate")
    private Date passwordExpireDate;

    @Column(name = "F_IsFirstTimeLogin")
...
//    }
    ...
    public String toString() {
        return "Staff{" +
                "oldPwdEncrypted='" + oldPwdEncrypted + '\'' +
                ", newPwdEncrypted='" + newPwdEncrypted + '\'' +
                ", sdf=" + sdf +
                ", ID=" + ID +
                ", phone='" + phone + '\'' +
                ", name='" + name + '\'' +
                ...
                ", isParesSyncDatetime=" + isParesSyncDatetime +
                ", oldMD5='" + oldMD5 + '\'' +
                ", newMD5='" + newMD5 + '\'' +
                ", isResetOtherPassword=" + isResetOtherPassword +
                ", involvedResigned=" + involvedResigned +
                ", roleID=" + roleID +
                ", isBXStaff=" + isBXStaff +
                ", openID='" + openID + '\'' +
                ", isLoginFromPos=" + isLoginFromPos +
                '}';
    }
    ...
    public BaseModel doParse1(JSONObject object) {
        ...
        try {
            ...
            isFirstTimeLogin = object.getInteger(field.getFIELD_NAME_isFirstTimeLogin());
            salt = object.getString(field.getFIELD_NAME_salt());
            pwdEncrypted = object.getString(field.getFIELD_NAME_pwdEncrypted());
            shopID = object.getInteger(field.getFIELD_NAME_shopID());
            departmentID = object.getInteger(field.getFIELD_NAME_departmentID());
            status = object.getInteger(field.getFIELD_NAME_status());
            returnObject = object.getInteger(field.getFIELD_NAME_returnObject());
            roleID = object.getInteger(field.getFIELD_NAME_roleID());//...登录时返回改值，判断角色
            openID = object.getString(field.getFIELD_NAME_openID());
...
////            }
            ...
            isLoginFromPos = object.getInteger(field.getFIELD_NAME_isLoginFromPos());
            return this;
        } catch (Exception e) {
    ...
    public BaseModel parse1(String s) {
        ...
        try {
            JSONObject joSTAFF = JSONObject.parseObject(s);
