...
public class BaseModelField {
	...
	// protected String FIELD_NAME_float1;
	//
	// public String getFIELD_NAME_float1() {
	// return "float1";
	// }
	//
	// protected String FIELD_NAME_float2;
	//
	// public String getFIELD_NAME_float2() {
	// return "float2";
	// }

	// protected String FIELD_NAME_string1;
	//
	// public String getFIELD_NAME_string1() {
	// return "string1";
	// }
	//
	// protected String FIELD_NAME_string2;
	//
	// public String getFIELD_NAME_string2() {
	// return "string2";
	// }
	//
	// protected String FIELD_NAME_string3;
	//
	// public String getFIELD_NAME_string3() {
	// return "string3";
	// }
