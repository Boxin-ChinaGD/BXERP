...
public class RetailTradeDailyReportByCategoryParentField extends BaseModelField {
	...
	protected String FIELD_NAME_categoryParentID;

	public String getFIELD_NAME_categoryParentID() {
	...
	protected String FIELD_NAME_categoryParentName;

	public String getFIELD_NAME_categoryParentName() {
		return "categoryParentName";
	}

	protected String FIELD_NAME_totalAmountSummary;

	public String getFIELD_NAME_totalAmountSummary() {
