SELECT '++++++++++++++++++ Test_SPD_Inventory_CheckStaffID.sql ++++++++++++++++++++';
...
--	SELECT @iErrorCode, @sErrorMsg;
--	-- 
--	SELECT IF(@sErrorMsg = CONCAT('盘点单', @iInventorysheetID ,'对应的经办人ID不正确') AND @iErrorCode = 7, '测试成功', '测试失败') AS 'Case2 Testing Result';
--	-- 
