...
SELECT '-------------------- Case1:查询某个会员的优惠券总数 -------------------------' AS 'Case1';
...
SELECT '-------------------- Case2:查询不存在的会员优惠券总数 -------------------------' AS 'Case2';
SET @iErrorCode = 0;
SET @sErrorMsg = '';
SET @iTotalRecord = 0;
SET @iVipID = -1;
...
SELECT '-------------------- Case3:查询的会员他优惠券全部都已核销 -------------------------' AS 'Case3';
INSERT INTO T_VIP (F_SN,F_CardID,F_ICID,F_Name,F_Email,F_ConsumeTimes,F_ConsumeAmount,F_District,F_Category,F_Birthday,F_Bonus,F_LastConsumeDatetime, F_Mobile)
VALUES ('VIP000101'/*F_SN*/,1/*F_CardID*/,'3208031997070216031'/*F_ICID*/,'g4iggs'/*F_Name*/,'12323456@bx.vip'/*F_Email*/,5/*F_ConsumeTimes*/,99.8/*F_ConsumeAmount*/,
'广州'/*F_District*/,1/*F_Category*/,'2017-08-06'/*F_Birthday*/,0/*F_Bonus*/,'2017-08-08 23:59:10'/*F_LastConsumeDatetime*/,'13545678170'/*F_Mobile*/);
SET @iVipID = last_insert_id();
...
SET @iTotalRecord = 0;
CALL SP_CouponCode_RetrieveNTotalByVipID(@iErrorCode, @sErrorMsg, @iVipID, @iTotalRecord);
SELECT IF(@iTotalRecord = 0 AND @iErrorCode = 0, '测试成功', '测试失败') AS 'CASE3 Testing Result';
-- 
DELETE FROM t_couponcode WHERE F_ID = @iCouponCodeID;
DELETE FROM t_coupon WHERE F_ID = @iCouponID;
DELETE FROM t_vip WHERE F_ID = @iVipID;

SELECT '-------------------- Case4:这种优惠券已经删除,但是会员领取优惠券还未使用(能查询出来) -------------------------' AS 'Case4';
INSERT INTO T_VIP (F_SN,F_CardID,F_ICID,F_Name,F_Email,F_ConsumeTimes,F_ConsumeAmount,F_District,F_Category,F_Birthday,F_Bonus,F_LastConsumeDatetime, F_Mobile)
VALUES ('VIP000101'/*F_SN*/,1/*F_CardID*/,'3208031997070216031'/*F_ICID*/,'g4iggs'/*F_Name*/,'12323456@bx.vip'/*F_Email*/,5/*F_ConsumeTimes*/,99.8/*F_ConsumeAmount*/,
'广州'/*F_District*/,1/*F_Category*/,'2017-08-06'/*F_Birthday*/,0/*F_Bonus*/,'2017-08-08 23:59:10'/*F_LastConsumeDatetime*/,'13545678170'/*F_Mobile*/);
SET @iVipID = last_insert_id();
...
SELECT '-------------------- Case5:这种优惠券已经过期,但是会员领取优惠券还未使用(不能查询出来) -------------------------' AS 'Case5';
INSERT INTO T_VIP (F_SN,F_CardID,F_ICID,F_Name,F_Email,F_ConsumeTimes,F_ConsumeAmount,F_District,F_Category,F_Birthday,F_Bonus,F_LastConsumeDatetime, F_Mobile)
VALUES ('VIP000101'/*F_SN*/,1/*F_CardID*/,'3208031997070216031'/*F_ICID*/,'g4iggs'/*F_Name*/,'12323456@bx.vip'/*F_Email*/,5/*F_ConsumeTimes*/,99.8/*F_ConsumeAmount*/,
'广州'/*F_District*/,1/*F_Category*/,'2017-08-06'/*F_Birthday*/,0/*F_Bonus*/,'2017-08-08 23:59:10'/*F_LastConsumeDatetime*/,'13545678170'/*F_Mobile*/);
SET @iVipID = last_insert_id();
...
SET @iTotalRecord = 0;
CALL SP_CouponCode_RetrieveNTotalByVipID(@iErrorCode, @sErrorMsg, @iVipID, @iTotalRecord);
SELECT IF(@iTotalRecord = 0 AND @iErrorCode = 0, '测试成功', '测试失败') AS 'CASE5 Testing Result';
-- 
DELETE FROM t_couponcode WHERE F_ID = @iCouponCodeID;
DELETE FROM t_coupon WHERE F_ID = @iCouponID;
DELETE FROM t_vip WHERE F_ID = @iVipID;