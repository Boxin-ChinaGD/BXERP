SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case14.sql+++++++++++++++++++++++';

SELECT '----- case14: 员工A创建一个零售单卖A一个商品，对应一个入库单 -------' AS 'Case14';
-- 
...
SET @rtcs1NO = 500;
-- 入库单
SET @warehousingCommodityNO=500;
SET @warehousingCommodityPrice=10;
...
VALUES (@warehouseA1, @commIDA, @warehousingCommodityNO, 3, '跨库商品A', @barcodeIDA, @warehousingCommodityPrice, 5000, '2119-01-01 06:00:00', 36, '2119-01-09 06:00:00', '2119-01-01 06:00:00', '2119-01-01 06:00:00', 5);
...
VALUES (@staffIDA, 2, @rggWorkTimeStart1, @rggWorkTimeEnd1, @rggNO1, @rggTotalAmount1, 150000.000000, @rggTotalAmountCash1, @rggTotalAmountWeChat1, @rggTotalAmountAliPay1, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, now());
...
SELECT @iErrorCode;
SELECT @sErrorMsg;
SELECT IF(@iErrorCode = 0, '测试成功', '测试失败') AS 'Case14.1 Testing Result';
