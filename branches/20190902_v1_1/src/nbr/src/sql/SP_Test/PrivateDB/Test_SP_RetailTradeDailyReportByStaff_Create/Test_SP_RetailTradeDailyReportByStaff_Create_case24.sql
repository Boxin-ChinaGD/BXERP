SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case24.sql+++++++++++++++++++++++';

SELECT '----- case24:员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应两个入库单 , C商品，对应两个入库单,员工B创建一张退货单，对商品A、B全部退货[A、B]-------' AS 'Case24';
-- 收银员
SET @staffID_A = 9;
SET @staffID_B = 10;
...
SET @warehousingCommodityA_Price1 = 9.000001; -- 入库单1
SET @warehousingCommodityA_NO1 = 500;
SET @warehousingCommodityA_Price2 = 8.000002; -- 入库单2
SET @warehousingCommodityA_NO2 = 1000;
SET @commodityPriceB = 220;
SET @warehousingCommodityB_Price1 = 7.000003;
SET @warehousingCommodityB_NO1 = 500;
SET @warehousingCommodityB_Price2 = 6.000004;
SET @warehousingCommodityB_NO2 = 1000;
SET @commodityPriceC = 770;
SET @warehousingCommodityC_Price1 = 5.000005;
SET @warehousingCommodityC_NO1 = 500;
SET @warehousingCommodityC_Price2 = 4.000004;
SET @warehousingCommodityC_NO2 = 1000;

-- 零售单1
SET @rt1SaleDatetimeA = '2041/02/02 06:00:00'; -- 创建零售单时间
SET @rt1CommotidyNO1_A = 99; -- 入库单1
SET @rt1CommotidyNO2_A = 999; -- 入库单2
SET @rt1CommotidyPrice_A = 199.9;
SET @rt1CommotidyNO1_B = 88; -- 入库单1
SET @rt1CommotidyNO2_B = 888; -- 入库单2
SET @rt1CommotidyPrice_B = 188.8;
SET @rt1CommotidyNO1_C = 77; -- 入库单1
SET @rt1CommotidyNO2_C = 777; -- 入库单2
SET @rt1CommotidyPrice_C = 177.7;
SET @rt1TotalAmount_A = (@rt1CommotidyNO1_A + @rt1CommotidyNO2_A) * @rt1CommotidyPrice_A -- 
		+ (@rt1CommotidyNO1_B + @rt1CommotidyNO2_B) * @rt1CommotidyPrice_B -- 
		+ (@rt1CommotidyNO1_C + @rt1CommotidyNO2_C) * @rt1CommotidyPrice_C; -- 零售总额
...
SET @rrt1CommotidyNO1_B = @rt1CommotidyNO1_B;
SET @rrt1CommotidyNO2_B = @rt1CommotidyNO2_B;
SET @rrt1TotalAmount_B = (@rrt1CommotidyNO1_A + @rrt1CommotidyNO2_A) * @rt1CommotidyPrice_A -- 
		+ (@rrt1CommotidyNO1_B + @rrt1CommotidyNO2_B) * @rt1CommotidyPrice_B; -- 退货总额
...
SET @rggTotalAmountCash_B = 0 - @rrt1AmuontCash_B;
...
SET @warehousingA1 = last_insert_id();
-- 创建入库商品1
...
VALUES (@warehousingA1, @commIDA, @warehousingCommodityA_NO1, 3, '跨库商品A', @barcodeIDA, @warehousingCommodityA_Price1, (@warehousingCommodityA_Price1 * @warehousingCommodityA_NO1), -- 
...
VALUES (@rtA_CommIDA, @commIDA, @rt1CommotidyNO1_A, @warehousingA1);
...
-- 售卖商品B
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rtIDA, @commIDB, '普通商品B', @barcodeIDB, (@rt1CommotidyNO1_B + @rt1CommotidyNO2_B), @commodityPriceB, (@rt1CommotidyNO1_B + @rt1CommotidyNO2_B), @rt1CommotidyPrice_B, 200, NULL);
SET @rtA_CommIDB = last_insert_id();
-- 创建零售单商品B的来源表1(对应的是入库单1)
INSERT INTO t_retailtradecommoditysource (F_RetailTradeCommodityID, F_ReducingCommodityID, F_NO, F_WarehousingID)
VALUES (@rtA_CommIDB, @commIDB, @rt1CommotidyNO1_B, @warehouseB1);
SET @rtA_CommsourceIDB1 = last_insert_id();
-- 创建零售单商品B的来源表2(对应的是入库单2)
INSERT INTO t_retailtradecommoditysource (F_RetailTradeCommodityID, F_ReducingCommodityID, F_NO, F_WarehousingID)
VALUES (@rtA_CommIDB, @commIDB, @rt1CommotidyNO2_B, @warehouseB2);
SET @rtA_CommsourceIDB2 = last_insert_id();
-- 售卖商品C
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rtIDA, @commIDC, '普通商品C', @barcodeIDC, (@rt1CommotidyNO1_C + @rt1CommotidyNO2_C), @commodityPriceC, (@rt1CommotidyNO1_C + @rt1CommotidyNO2_C), @rt1CommotidyPrice_C, 700, NULL);
SET @rtA_CommIDC = last_insert_id();
-- 创建零售单商品C的来源表1(对应的是入库单1)
INSERT INTO t_retailtradecommoditysource (F_RetailTradeCommodityID, F_ReducingCommodityID, F_NO, F_WarehousingID)
VALUES (@rtA_CommIDC, @commIDC, @rt1CommotidyNO1_C, @warehouseC1);
SET @rtA_CommsourceIDC1 = last_insert_id();
-- 创建零售单商品C的来源表2(对应的是入库单2)
INSERT INTO t_retailtradecommoditysource (F_RetailTradeCommodityID, F_ReducingCommodityID, F_NO, F_WarehousingID)
VALUES (@rtA_CommIDC, @commIDC, @rt1CommotidyNO2_C, @warehouseC2);
...
VALUES (1,'LS2041020200000500010001_1',11069,1,'url=ashasoadigmnalskd',@rrt1SaleDatetimeB,@staffID_B,1,'0',1,'…',@rtIDA/*F_SourceID*/,@rrt1SaleDatetimeB,@rrt1TotalAmount_B,@rrt1AmuontCash_B,@rrt1AmuontAliPay_B,@rrt1AmuontWeChat_B,0.000000,0.000000,0.000000,0.000000,0.000000,1,NULL,NULL,NULL,NULL,NULL,NULL,2);
SET @returnIDB = last_insert_id();
-- 创建零售退货单商品A
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@returnIDB, @commIDA, '普通商品A', @barcodeIDA, (@rrt1CommotidyNO1_A + @rrt1CommotidyNO2_A), @commodityPriceA, (@rrt1CommotidyNO1_A + @rrt1CommotidyNO2_A), @rt1CommotidyPrice_A, 300, NULL);
...
VALUES (@returnCommIDA, @commIDA, @rrt1CommotidyNO1_A, @warehousingA1);
...
-- 创建零售退货单商品B
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@returnIDB, @commIDB, '普通商品B', @barcodeIDB, (@rrt1CommotidyNO1_B + @rrt1CommotidyNO2_B), @commodityPriceB, (@rrt1CommotidyNO1_B + @rrt1CommotidyNO2_B), @rt1CommotidyPrice_B, 200, NULL);
SET @returnCommIDB = last_insert_id();
-- 创建零售退货单商品B的退货去向数据1
INSERT INTO t_returnretailtradecommoditydestination(F_RetailTradeCommodityID, F_IncreasingCommodityID, F_NO, F_WarehousingID)
VALUES (@returnCommIDB, @commIDB, @rrt1CommotidyNO1_B, @warehouseB1);
SET @returnAggB1 = last_insert_id();
-- 创建零售退货单商品B的退货去向数据2
INSERT INTO t_returnretailtradecommoditydestination(F_RetailTradeCommodityID, F_IncreasingCommodityID, F_NO, F_WarehousingID)
VALUES (@returnCommIDB, @commIDB, @rrt1CommotidyNO2_B, @warehouseB2);
SET @returnAggB2 = last_insert_id();
-- 
SET @iErrorCode = 0;
SET @sErrorMsg = '';
...
SELECT IF(@iErrorCode = 0, '测试成功', '测试失败') AS 'Case23.1 Testing Result';
-- 
-- 验证A的员工业绩(1)员工业绩报表是否有B的默认数据插入(2)销售总额(3)销售笔数(4)销售毛利
SET @countDefaultDataA = 0;
SELECT COUNT(1) INTO @countDefaultDataA FROM t_retailtradedailyreportbystaff WHERE F_Datetime = @dSaleDatetime AND F_StaffID = @staffID_A;
SELECT IF(@countDefaultDataA = 1, '测试成功', '测试失败') AS 'Case23.2 Testing Result';
...
SELECT IF(@totalAmountA = @rt1TotalAmount_A , '测试成功', '测试失败') AS 'Case23.3 Testing Result';
-- 
...
SELECT IF(@retailtradeNOA = @rtNoByStaffA, '测试成功', '测试失败') AS 'Case23.4 Testing Result';
-- 
-- 进行业绩报表的毛利结果验证
...
SELECT F_GrossMargin INTO @grossMarginA FROM t_retailtradedailyreportbystaff WHERE F_StaffID = @staffID_A AND F_Datetime = @dSaleDatetime;
 -- 销售毛利
SET @saleGrossMargin =  @rt1TotalAmount_A - (@rt1CommotidyNO1_A * @warehousingCommodityA_Price1) - (@rt1CommotidyNO2_A * @warehousingCommodityA_Price2) -- 
					- (@rt1CommotidyNO1_B * @warehousingCommodityB_Price1) - (@rt1CommotidyNO2_B * @warehousingCommodityB_Price2) -- 
					- (@rt1CommotidyNO1_C * @warehousingCommodityC_Price1) - (@rt1CommotidyNO2_C * @warehousingCommodityC_Price2);
SELECT IF(@grossMarginA = @saleGrossMargin, '测试成功', '测试失败') AS 'Case23.5 Testing Result';
-- 
...
SELECT IF(@countDefaultDataB = 1, '测试成功', '测试失败') AS 'Case23.6 Testing Result';
...
SELECT IF(@totalAmountB = 0 - @rrt1TotalAmount_B, '测试成功', '测试失败') AS 'Case23.7 Testing Result';
...
SELECT IF(@retailtradeNOB = @rtNoByStaffB, '测试成功', '测试失败') AS 'Case23.8 Testing Result';
...
SELECT F_GrossMargin INTO @grossMarginB FROM t_retailtradedailyreportbystaff WHERE F_StaffID = @staffID_B AND F_Datetime = @dSaleDatetime;
 -- 退货毛利
SET @returnGrossMargin = (@rrt1CommotidyNO1_A * @warehousingCommodityA_Price1) + (@rrt1CommotidyNO2_A * @warehousingCommodityA_Price2) -- 
		+ (@rrt1CommotidyNO1_B * @warehousingCommodityB_Price1) + (@rrt1CommotidyNO2_B * @warehousingCommodityB_Price2) - @rrt1TotalAmount_B;
SELECT IF(@grossMarginB = @returnGrossMargin, '测试成功', '测试失败') AS 'Case23.9 Testing Result';
-- 
...
DELETE FROM t_returnretailtradecommoditydestination WHERE F_ID = @returnAggB1;
DELETE FROM t_returnretailtradecommoditydestination WHERE F_ID = @returnAggB2;
...
DELETE FROM t_warehousing WHERE F_ID = @warehousingA1;
