...
SELECT '----- case25:员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应两个入库单 , C商品，对应两个入库单,员工B创建一张退货单，对商品A、B部分退货[AB]-------' AS 'Case25';
-- 收银员
SET @staffID_A = 9;
SET @staffID_B = 10;
...
SET @warehousingCommodityA_Price1 = 9.369852; -- 入库单1
SET @warehousingCommodityA_NO1 = 500;
SET @warehousingCommodityA_Price2 = 8.852147; -- 入库单2
SET @warehousingCommodityA_NO2 = 1000;
SET @commodityPriceB = 220;
SET @warehousingCommodityB_Price1 = 7.123654;
SET @warehousingCommodityB_NO1 = 500;
SET @warehousingCommodityB_Price2 = 6.987456;
SET @warehousingCommodityB_NO2 = 1000;
SET @commodityPriceC = 770;
SET @warehousingCommodityC_Price1 = 5.951753;
SET @warehousingCommodityC_NO1 = 500;
SET @warehousingCommodityC_Price2 = 4.321478;
...
SET @saleGrossMargin =  @rt1TotalAmount_A - (@rt1CommotidyNO1_A * @warehousingCommodityA_Price1) - (@rt1CommotidyNO2_A * @warehousingCommodityA_Price2) -- 
 ...
 -- 退货毛利
SET @returnGrossMargin = @rrt1TotalAmount_B - (@rrt1CommotidyNO2_A * @warehousingCommodityA_Price2) -- 
		- (@rrt1CommotidyNO2_B * @warehousingCommodityB_Price2);
