SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case26.sql+++++++++++++++++++++++';


SELECT '----- case26:员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应两个入库单 , C商品，对应两个入库单,员工B创建一张退货单，对商品A、B部分退货[A、B]-------' AS 'Case26';
-- 收银员
SET @staffID_A = 9;
SET @staffID_B = 10;
...
SET @warehousingCommodityA_Price1 = 9.22; -- 入库单1
SET @warehousingCommodityA_NO1 = 500;
SET @warehousingCommodityA_Price2 = 8.33; -- 入库单2
SET @warehousingCommodityA_NO2 = 500;
SET @commodityPriceB = 220;
SET @warehousingCommodityB_Price1 = 7.44;
SET @warehousingCommodityB_NO1 = 500;
SET @warehousingCommodityB_Price2 = 6.55;
SET @warehousingCommodityB_NO2 = 500;
SET @commodityPriceC = 770;
SET @warehousingCommodityC_Price1 = 5.66;
SET @warehousingCommodityC_NO1 = 500;
SET @warehousingCommodityC_Price2 = 4.77;
SET @warehousingCommodityC_NO2 = 500;
...
SET @rrt1TotalAmount_B = @rrt1CommotidyNO2_A * @rt1CommotidyPrice_A -- 
		+ @rrt1CommotidyNO2_B * @rt1CommotidyPrice_B; -- 退货总额
...
-- 创建零售退货单商品A
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@returnIDB, @commIDA, '普通商品A', @barcodeIDA, @rrt1CommotidyNO2_A, @commodityPriceA, @rrt1CommotidyNO2_A, @rt1CommotidyPrice_A, 300, NULL);
...
-- 创建零售退货单商品B
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@returnIDB, @commIDB, '普通商品B', @barcodeIDB, @rrt1CommotidyNO2_B, @commodityPriceB, @rrt1CommotidyNO2_B, @rt1CommotidyPrice_B, 200, NULL);
...
SELECT F_GrossMargin INTO @grossMarginB FROM t_retailtradedailyreportbystaff WHERE F_StaffID = @staffID_B AND F_Datetime = @dSaleDatetime;
 -- 退货毛利
SET @returnGrossMargin = (@rrt1CommotidyNO2_A * @warehousingCommodityA_Price2) + (@rrt1CommotidyNO2_B * @warehousingCommodityB_Price2) - @rrt1TotalAmount_B;
