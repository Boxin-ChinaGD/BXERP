SELECT '----- case36:员工A创建一个零售单卖A商品，对应两个入库单 ,卖B商品，对应两个入库单 , 卖C商品，对应两个入库单,A隔天创建一张退货单，对商品A、B全部退货,对C部分退货 [A、A]-------' AS 'Case36';
-- 
-- 员工ID
SET @staffIDA = 9;
-- 
...
SET @returnCommBNO_A = @saleCommBNO_A; -- 全退
SET @returnCommCNO_A = 50;
...
SET @rrtTotalAmount_A = @returnCommANO_A * @aCommotidyPrice + @returnCommBNO_A * @bCommotidyPrice + @returnCommCNO_A * @cCommotidyPrice;
SET @saleDatetime_A = '2041/02/02 07:00:01';
SET @syncDatetime_A = '2041/02/02 07:00:01';

INSERT INTO t_retailtrade (F_VipID, F_SN, F_LocalSN, F_POS_ID, F_Logo, F_SaleDatetime, F_StaffID, F_PaymentType, F_PaymentAccount, F_Status, F_Remark, F_SourceID, F_SyncDatetime, F_Amount, F_AmountCash, F_AmountAlipay, F_AmountWeChat, F_Amount1, F_Amount2, F_Amount3, F_Amount4, F_Amount5, F_SmallSheetID, F_AliPayOrderSN, F_WxOrderSN, F_WxTradeNO, F_WxRefundNO, F_WxRefundDesc, F_WxRefundSubMchID, F_ShopID)
VALUES (1,'LS2041020200000500010001_1',11069,1,'url=ashasoadigmnalskd',@saleDatetime_A,@staffIDA,1,'0',1,'…',@rtID_A,@syncDatetime_A,@rrtTotalAmount_A,@rrtAmuontCash_A,@rrtAmuontAliPay_A,@rrtAmuontWeChat_A,0.000000,0.000000,0.000000,0.000000,0.000000,1,NULL,NULL,NULL,NULL,NULL,NULL,2);
SET @rrtID_A = last_insert_id();

-- 零售商品A
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rrtID_A, @commIDA, '普通商品A', 1, @returnCommANO_A, @aCommotidyPrice, @returnCommANO_A, @aCommotidyPrice, 300, NULL);
SET @rrtCommAID_A = last_insert_id();
-- 零售商品B
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rrtID_A, @commIDB, '可口可乐', 3, @returnCommBNO_A, @bCommotidyPrice, @returnCommBNO_A, @bCommotidyPrice, 200, NULL);
SET @rrtCommBID_A = last_insert_id();
-- 零售商品C
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rrtID_A, @commIDC, '普通商品C', @barcodeIDC, @returnCommCNO_A, @cCommotidyPrice, @returnCommCNO_A, @cCommotidyPrice, 700, NULL);
SET @rrtCommCID_A = last_insert_id();
-- 
-- 插入退货去向表
...
VALUES (@rrtCommAID_A, @commIDA, @NOReturnToA2, @warehouseA2);
SET @returnAggA1_A = last_insert_id();
INSERT INTO t_returnretailtradecommoditydestination(F_RetailTradeCommodityID, F_IncreasingCommodityID, F_NO, F_WarehousingID)
VALUES (@rrtCommAID_A, @commIDA, @NOReturnToA1, @warehouseA1);
SET @returnAggA2_A = last_insert_id();
-- 商品B
INSERT INTO t_returnretailtradecommoditydestination(F_RetailTradeCommodityID, F_IncreasingCommodityID, F_NO, F_WarehousingID)
VALUES (@rrtCommBID_A, @commIDB, @NOReturnToB2, @warehouseB2);
SET @returnAggB1_A = last_insert_id();
INSERT INTO t_returnretailtradecommoditydestination(F_RetailTradeCommodityID, F_IncreasingCommodityID, F_NO, F_WarehousingID)
VALUES (@rrtCommBID_A, @commIDB, @NOReturnToB1, @warehouseB1);
SET @returnAggB2_A = last_insert_id();
-- 商品C
INSERT INTO t_returnretailtradecommoditydestination(F_RetailTradeCommodityID, F_IncreasingCommodityID, F_NO, F_WarehousingID)
VALUES (@rrtCommCID_A, @commIDC, @NOReturnToC2, @warehouseC2);
SET @returnAggC1_A = last_insert_id();
INSERT INTO t_returnretailtradecommoditydestination(F_RetailTradeCommodityID, F_IncreasingCommodityID, F_NO, F_WarehousingID)
VALUES (@rrtCommCID_A, @commIDC, @NOReturnToC1, @warehouseC1);
SET @returnAggC2_A = last_insert_id();
-- 
-- 零售单收银汇总
SET @rggWorkTimeStart='2041/02/01 00:00:00';
SET @rggWorkTimeEnd='2041/02/01 23:59:59';
SET @rggTotalAmount = @rrtTotalAmount_A;
SET @rggTotalAmountCash = @rrtAmuontCash_A;
SET @rggTotalAmountWeChat = @rrtAmuontWeChat_A;
SET @rggTotalAmountAliPay = @rrtAmuontAliPay_A;
SET @rggNO = 1;
-- 
...
VALUES (@staffIDA, 2, @rggWorkTimeStart, @rggWorkTimeEnd, @rggNO, @rggTotalAmount, 0.000000, @rggTotalAmountCash, @rggTotalAmountWeChat, @rggTotalAmountAliPay, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, now());
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification_A = 1,'测试成功','测试失败') AS 'Test Case36 Result';
...
-- 验证员工A在02/02当天只有退货
-- 售卖总金额
SET @saleTotalAmount_A = 0.000000;
-- 售卖商品总成本
...
DELETE FROM t_retailtradecommoditysource WHERE F_ID = @returnCommsourceIDA1_A;
DELETE FROM t_retailtradecommoditysource WHERE F_ID = @returnCommsourceIDA2_A;
DELETE FROM t_retailtradecommoditysource WHERE F_ID = @returnCommsourceIDB1_A;
DELETE FROM t_retailtradecommoditysource WHERE F_ID = @returnCommsourceIDB2_A;
DELETE FROM t_retailtradecommoditysource WHERE F_ID = @returnCommsourceIDC1_A;
DELETE FROM t_retailtradecommoditysource WHERE F_ID = @returnCommsourceIDC2_A;
DELETE FROM t_returnretailtradecommoditydestination WHERE F_ID = @returnAggA1_A;
DELETE FROM t_returnretailtradecommoditydestination WHERE F_ID = @returnAggA2_A;
DELETE FROM t_returnretailtradecommoditydestination WHERE F_ID = @returnAggB1_A;
DELETE FROM t_returnretailtradecommoditydestination WHERE F_ID = @returnAggB2_A;
DELETE FROM t_returnretailtradecommoditydestination WHERE F_ID = @returnAggC1_A;
DELETE FROM t_returnretailtradecommoditydestination WHERE F_ID = @returnAggC2_A;
...
DELETE FROM t_retailtradecommodity WHERE F_ID = @rrtCommAID_A;
DELETE FROM t_retailtradecommodity WHERE F_ID = @rrtCommBID_A;
DELETE FROM t_retailtradecommodity WHERE F_ID = @rrtCommCID_A;
