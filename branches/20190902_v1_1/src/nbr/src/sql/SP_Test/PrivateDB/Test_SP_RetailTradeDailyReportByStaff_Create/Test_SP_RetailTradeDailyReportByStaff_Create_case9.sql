SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_Case9.sql+++++++++++++++++++++++';

SELECT '-----------------Case9:员工A,B上班进行售卖，员工A退A当天的货，但B不销售商品。 ------------------' AS 'Case9';
-- 插入商品
...
SET @rt2AmuontCash_A = 183.200000;
...
-- 退货单(退零售单1)
SET @rrt1CommotidyNO_A = 6;
SET @rrt1CommotidyPrice_A = @rt2CommotidyPrice3_A; -- 
SET @rrt1AmuontCash_A = 0.000000;
SET @rrt1AmuontWeChat_A = 206.940000;
...
SET @rggWorkTimeEnd_A='2130-01-01 23:59:59';
...
SET @rggNO_A = 2;
-- 店员9不进行售卖
SET @rggWorkTimeStart_B='2130-01-01 00:00:00';
...
VALUES (1,'LS2130010100000500010001',11068,1,'url=ashasoadigmnalskd',@saleDatetime,@iStaffIDA,1,'0',1,'…',-1,@syncDatetime,@rt1TotalAmount_A,@rt1AmuontCash_A,@rt1AmuontAliPay_A,@rt1AmuontWeChat_A,0.000000,0.000000,0.000000,0.000000,0.000000,1,NULL,NULL,NULL,NULL,NULL,NULL,2);
SET @rtID1_A = last_insert_id();
-- 退货单，退@rtID1_A的货
INSERT INTO t_retailtrade (F_VipID, F_SN, F_LocalSN, F_POS_ID, F_Logo, F_SaleDatetime, F_StaffID, F_PaymentType, F_PaymentAccount, F_Status, F_Remark, F_SourceID, F_SyncDatetime, F_Amount, F_AmountCash, F_AmountAlipay, F_AmountWeChat, F_Amount1, F_Amount2, F_Amount3, F_Amount4, F_Amount5, F_SmallSheetID, F_AliPayOrderSN, F_WxOrderSN, F_WxTradeNO, F_WxRefundNO, F_WxRefundDesc, F_WxRefundSubMchID, F_ShopID)
VALUES (1,'LS2130010100000500010001_1',11069,1,'url=ashasoadigmnalskd',@saleDatetime,@iStaffIDA,1,'0',1,'…',@rtID1_A,@syncDatetime,@rrt1TotalAmount_A,@rrt1AmuontCash_A,@rrt1AmuontAliPay_A,@rrt1AmuontWeChat_A,0.000000,0.000000,0.000000,0.000000,0.000000,1,NULL,NULL,NULL,NULL,NULL,NULL,2);
...
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rtID2_A,@iCommodityID3,'紫云剑',247,@rrt1CommotidyNO_A,34.490000,0,@rrt1CommotidyPrice_A,NULL,34.490000);
SET @rtCommID4_A = last_insert_id();
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rtID3_A,@iCommodityID1,'长虹剑',245,@rt2CommotidyNO1_A,18.320000,9,@rt2CommotidyPrice1_A,NULL,18.320000);
SET @rtCommID5_A = last_insert_id();
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rtID3_A,@iCommodityID2,'冰魄剑',246,@rt2CommotidyNO2_A,61.590000,0,@rt2CommotidyPrice2_A,NULL,61.590000);
SET @rtCommID6_A = last_insert_id();
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rtID3_A,@iCommodityID3,'紫云剑',247,@rt2CommotidyNO3_A,34.490000,2,@rt2CommotidyPrice3_A,NULL,34.490000);
SET @rtCommID7_A = last_insert_id();
...
INSERT INTO t_retailtradecommoditysource (F_RetailTradeCommodityID, F_ReducingCommodityID, F_NO, F_WarehousingID)
VALUES (@rtCommID5_A,@commodityID216,@rtcs4NO_A,@rtcs4WarehousingID_A);
SET @rtCommSourceID4_A = last_insert_id();
INSERT INTO t_retailtradecommoditysource (F_RetailTradeCommodityID, F_ReducingCommodityID, F_NO, F_WarehousingID)
VALUES (@rtCommID6_A,@commodityID217,@rtcs5NO_A,@rtcs5WarehousingID_A);
SET @rtCommSourceID5_A = last_insert_id();
INSERT INTO t_retailtradecommoditysource (F_RetailTradeCommodityID, F_ReducingCommodityID, F_NO, F_WarehousingID)
VALUES (@rtCommID7_A,@commodityID218,@rtcs6NO_A,@rtcs6WarehousingID_A);
...
VALUES (@rtCommID4_A, @destinationCommodityID218, @rtcd1NO_A, @rtcd1WarehousingID_A);
...
-- 退货商品总成本
SET @returnTotalCost_A = (@rtcd1NO_A * (SELECT F_Price FROM t_warehousingcommodity WHERE F_WarehousingID = @rtcd1WarehousingID_A AND F_CommodityID = @destinationCommodityID218));
-- 退货商品总毛利
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification1 = 1,'测试成功','测试失败') AS 'Test Case9 Result';
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification2 = 1,'测试成功','测试失败') AS 'Test Case5 Result';
...
DELETE FROM t_retailtradecommodity WHERE F_ID = @rtCommID7_A;
