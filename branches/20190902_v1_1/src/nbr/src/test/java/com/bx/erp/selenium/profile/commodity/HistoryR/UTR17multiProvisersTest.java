...
import java.util.*;
public class UTR17multiProvisersTest {
  ...
  @Test
  public void uTR17multiProvisers() {
    LoginSucceed();
...
//      assertThat(value, is("vars.get("commodityName").toString()"));
    ...
    if ((Boolean) js.executeScript("return (window.getComputedStyle(document.getElementById(\'otherProvider\'))[\'display\'] == \'none\')")) {
