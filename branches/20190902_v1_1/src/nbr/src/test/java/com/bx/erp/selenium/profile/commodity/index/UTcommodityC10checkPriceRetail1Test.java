...
import java.util.*;
public class UTcommodityC10checkPriceRetail1Test {
  ...
  @Test
  public void uTcommodityC10checkPriceRetail1() {
    LoginSucceed();
    ...
    driver.findElement(By.name("priceRetail")).sendKeys("-123");
    ...
    driver.findElement(By.name("priceRetail")).sendKeys("###");
    driver.findElement(By.cssSelector(".commodityInfo")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("格式错误，请输入非负数字，允许有两位小数"));
    driver.findElement(By.cssSelector(".layui-form-item:nth-child(11) > .layui-inline:nth-child(2)")).click();
    driver.findElement(By.name("priceRetail")).sendKeys("8888888888888");
    driver.findElement(By.cssSelector(".commodityPicture")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("格式错误，请输入非负数字，允许有两位小数"));
    driver.findElement(By.cssSelector(".layui-form-item:nth-child(11) > .layui-inline:nth-child(2)")).click();
    driver.findElement(By.name("priceRetail")).sendKeys("123.456789");
