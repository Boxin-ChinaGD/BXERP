...
import java.util.*;
public class UTcommodityC28checkReturnDays1Test {
  ...
  @Test
  public void uTcommodityC28checkReturnDays1() {
    LoginSucceed();
    ...
    driver.findElement(By.name("returnDays")).sendKeys("-12");
    ...
    driver.findElement(By.name("returnDays")).click();
    driver.findElement(By.name("returnDays")).sendKeys("12.3");
    driver.findElement(By.cssSelector(".btnChoosed")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("只允许非负整数"));
    driver.findElement(By.name("returnDays")).click();
    driver.findElement(By.name("returnDays")).sendKeys("-1.11");
    driver.findElement(By.cssSelector(".btnChoosed")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("只允许非负整数"));
    driver.findElement(By.name("returnDays")).click();
    driver.findElement(By.name("returnDays")).sendKeys("12345654321");
    driver.findElement(By.cssSelector(".btnChoosed")).click();
