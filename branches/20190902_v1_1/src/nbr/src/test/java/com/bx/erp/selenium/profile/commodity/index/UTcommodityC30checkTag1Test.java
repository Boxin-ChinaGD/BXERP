...
import java.util.*;
public class UTcommodityC30checkTag1Test {
  ...
  @Test
  public void uTcommodityC30checkTag1() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("商品的标注为中文或英文或数字或符号的组合"));
  }
}
