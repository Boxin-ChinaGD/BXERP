...
import java.util.*;
public class UTcommodityC32checkNOStart1Test {
  ...
  @Test
  public void uTcommodityC32checkNOStart1() {
    LoginSucceed();
    ...
    driver.findElement(By.name("nOStart")).click();
    driver.findElement(By.name("nOStart")).sendKeys("1.2");
    driver.findElement(By.cssSelector(".btnChoosed")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("只允许非负整数"));
    driver.findElement(By.name("nOStart")).click();
    driver.findElement(By.name("nOStart")).sendKeys("1234567890123");
    driver.findElement(By.cssSelector(".btnChoosed")).click();
