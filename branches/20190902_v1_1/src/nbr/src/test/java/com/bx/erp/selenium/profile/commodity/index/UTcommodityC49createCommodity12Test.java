...
import java.util.*;
public class UTcommodityC49createCommodity12Test {
  ...
  @Test
  public void uTcommodityC49createCommodity12() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("商品倍数需为大于1的正整数"));
    driver.findElement(By.cssSelector(".btnChoosed")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("商品倍数为大于1的整数"));
  }
}
