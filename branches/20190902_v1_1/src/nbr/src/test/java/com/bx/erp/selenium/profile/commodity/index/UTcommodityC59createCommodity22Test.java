...
import java.util.*;
public class UTcommodityC59createCommodity22Test {
  ...
  @Test
  public void uTcommodityC59createCommodity22() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("参考商品库没有此商品"));
  }
}
