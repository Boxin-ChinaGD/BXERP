...
import java.util.*;
public class UTcommodityC77createCommodity40Test {
  ...
  @Test
  public void uTcommodityC77createCommodity40() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".layui-table:nth-child(1) tr:nth-child(1) > td:nth-child(4) > input")).sendKeys(vars.get("commodityNO").toString());
