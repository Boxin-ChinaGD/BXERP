...
import java.util.*;
public class UTcommodityC78createCommodity41Test {
  ...
  @Test
  public void uTcommodityC78createCommodity41() {
    LoginSucceed();
    ...
    vars.put("commodityPrice", driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).getAttribute("value"));
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).click();
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).sendKeys("0");
    driver.findElement(By.id("middlePart")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("请输入正确的商品单价"));
    {
...
//      assertThat(value, is("vars.get("commodityPrice").toString()"));
    ...
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).click();
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).sendKeys("-123");
    driver.findElement(By.id("middlePart")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("请输入正确的商品单价"));
    {
      String value = driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).getAttribute("value");
...
//      assertThat(value, is("vars.get("commodityPrice").toString()"));
    ...
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).click();
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).sendKeys("everyday");
    driver.findElement(By.id("middlePart")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("请输入正确的商品单价"));
    {
      String value = driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).getAttribute("value");
...
//      assertThat(value, is("vars.get("commodityPrice").toString()"));
    ...
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).click();
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).sendKeys("123.45hhh");
    driver.findElement(By.id("middlePart")).click();
    {
      String value = driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).getAttribute("value");
    ...
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).click();
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).sendKeys("66.666666");
    driver.findElement(By.id("middlePart")).click();
    {
      String value = driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).getAttribute("value");
      assertThat(value, is("66.67"));
    }
  }
}
