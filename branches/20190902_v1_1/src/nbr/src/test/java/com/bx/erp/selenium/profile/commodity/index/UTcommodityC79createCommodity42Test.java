...
import java.util.*;
public class UTcommodityC79createCommodity42Test {
  ...
  @Test
  public void uTcommodityC79createCommodity42() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(6) > input")).sendKeys(vars.get("commodityPrice").toString());
