...
import java.util.*;
public class UTcommodityC818commodityPopupTest {
  ...
  @Test
  public void uTcommodityC818commodityPopup() {
    LoginSucceed();
    ...
    {
      List<WebElement> elements = driver.findElements(By.cssSelector(".layui-layer-padding"));
