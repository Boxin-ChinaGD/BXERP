...
import java.util.*;
public class UTcommodityC82createCommodityTest {
  ...
  @Test
  public void uTcommodityC82createCommodity() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".layui-form-item:nth-child(24)")).click();
