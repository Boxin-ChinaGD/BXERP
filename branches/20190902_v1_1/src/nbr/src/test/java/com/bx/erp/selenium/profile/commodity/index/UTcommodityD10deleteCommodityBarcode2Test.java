...
import java.util.*;
public class UTcommodityD10deleteCommodityBarcode2Test {
  ...
  @Test
  public void uTcommodityD10deleteCommodityBarcode2() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("条形码已删除"));
    driver.findElement(By.cssSelector(".toDeleteBarcode")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("已经是最后一个条形码了，不能删除了"));
  }
}
