...
import java.util.*;
public class UTcommodityD4deleteCommodity4Test {
  ...
  @Test
  public void uTcommodityD4deleteCommodity4() {
    LoginSucceed();
    ...
    driver.findElement(By.linkText("确定")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("该商品还有库存，不能删除"));
  }
}
