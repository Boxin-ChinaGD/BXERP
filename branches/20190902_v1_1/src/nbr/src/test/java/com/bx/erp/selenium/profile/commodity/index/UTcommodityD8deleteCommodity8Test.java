...
import java.util.*;
public class UTcommodityD8deleteCommodity8Test {
  ...
  @Test
  public void uTcommodityD8deleteCommodity8() {
    LoginSucceed();
    ...
    driver.findElement(By.linkText("确定")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("请先删除商品的副单位"));
  }
}
