...
import java.util.*;
public class UTcommodityR16viewSomeoneHadMultiPackageTest {
  ...
  @Test
  public void uTcommodityR16viewSomeoneHadMultiPackage() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".layui-input-inline:nth-child(4) > .layui-input")).sendKeys("2");
...
//      assertThat(value, is("vars.get("commodityPriceRetail").toString()"));
    ...
    assertTrue(driver.findElement(By.cssSelector(".toChoosedMultiUnit > input")).isSelected());
    {
