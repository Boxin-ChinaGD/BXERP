...
import java.util.*;
public class UTcommodityR23viewSomeoneIsServiceTest {
  ...
  @Test
  public void uTcommodityR23viewSomeoneIsService() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".layui-form-item:nth-child(14) > .layui-inline:nth-child(2) .layui-input")).sendKeys(vars.get("commoditySpecification").toString());
    ...
    driver.findElement(By.cssSelector(".layui-form-item:nth-child(15) > .layui-inline:nth-child(2) .layui-input")).sendKeys(vars.get("commodityPriceRetail").toString());
...
//      assertThat(value, is("vars.get("commodityName").toString()"));
    ...
    {
      String value = driver.findElement(By.cssSelector(".layui-form-item:nth-child(14) > .layui-inline:nth-child(2) .layui-input")).getAttribute("value");
      // TODO
//      assertThat(value, is("vars.get("commoditySpecification").toString()"));
    }
    {
      String value = driver.findElement(By.cssSelector(".layui-form-item:nth-child(15) > .layui-inline:nth-child(2) .layui-input")).getAttribute("value");
      // TODO
