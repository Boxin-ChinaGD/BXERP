...
import java.util.*;
public class UTcommodityU18updateMultiPackageInfo1Test {
  ...
  @Test
  public void uTcommodityU18updateMultiPackageInfo1() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".multiPackageCommName > td:nth-child(3) > .layui-input")).click();
    driver.findElement(By.cssSelector(".multiPackageCommName > td:nth-child(3) > .layui-input")).sendKeys(vars.get("multiCommodityName2").toString());
    driver.findElement(By.cssSelector(".multiPackageBarcode > td:nth-child(3) > .layui-input")).click();
    ...
    driver.findElement(By.cssSelector(".multiPackagePriceRetail > td:nth-child(3) > .layui-input")).sendKeys("555");
    driver.findElement(By.cssSelector(".multiPackagePriceVIP > td:nth-child(3) > .layui-input")).click();
    driver.findElement(By.cssSelector(".multiPackagePriceVIP > td:nth-child(3) > .layui-input")).sendKeys("666");
    driver.findElement(By.cssSelector(".multiPackagePriceWholesale > td:nth-child(3) > .layui-input")).click();
    driver.findElement(By.cssSelector(".multiPackagePriceWholesale > td:nth-child(3) > .layui-input")).sendKeys("777");
    driver.findElement(By.cssSelector(".btnChoosed")).click();
    driver.findElement(By.linkText("确定")).click();
