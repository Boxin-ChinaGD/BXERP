...
import java.util.*;
public class UTcommodityU28updateCommodity3Test {
  ...
  @Test
  public void uTcommodityU28updateCommodity3() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".serviceCommName")).sendKeys(vars.get("commodityName2").toString());
