...
import java.util.*;
public class UTcommodityU5createBarcode2Test {
  ...
  @Test
  public void uTcommodityU5createBarcode2() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("该条形码已存在"));
  }
}
