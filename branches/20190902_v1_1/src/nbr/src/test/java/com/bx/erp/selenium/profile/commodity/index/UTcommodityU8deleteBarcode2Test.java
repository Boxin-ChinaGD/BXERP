...
import java.util.*;
public class UTcommodityU8deleteBarcode2Test {
  ...
  @Test
  public void uTcommodityU8deleteBarcode2() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("删除的条形码在盘点单商品中有依赖"));
  }
}
