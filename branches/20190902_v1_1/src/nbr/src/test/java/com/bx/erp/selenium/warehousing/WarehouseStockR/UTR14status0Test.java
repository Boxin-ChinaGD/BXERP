...
public class UTR14status0Test {
  ...
  public void uTR14status0() {
    ...
    assertFalse(driver.findElement(By.name("status")).isSelected());
    try {
      Thread.sleep(1000);
    ...
    driver.findElement(By.cssSelector(".layui-form-checked > .layui-icon")).click();
    assertTrue(driver.findElement(By.name("status")).isSelected());
