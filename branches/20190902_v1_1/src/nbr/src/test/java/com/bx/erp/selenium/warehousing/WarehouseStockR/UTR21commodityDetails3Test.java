...
import java.util.*;
public class UTR21commodityDetails3Test {
  ...
  @Test
  public void uTR21commodityDetails3() {
    LoginSucceed();
    ...
    driver.findElement(By.name("queryKeyword")).sendKeys("可");
    driver.findElement(By.cssSelector(".layui-icon-search")).click();
    driver.findElement(By.xpath("//div[@id=\'warehouseListMain\']/div[2]/div[2]/div[2]/div/div/div[2]/table/tbody/tr[2]/td/div")).click();
    vars.put("commodityName", driver.findElement(By.xpath("//div[@id=\'warehouseListMain\']/div[2]/div[2]/div[2]/div/div/div[2]/table/tbody/tr[2]/td/div")).getText());
    vars.put("barcodes", driver.findElement(By.xpath("//div[@id=\'warehouseListMain\']/div[2]/div[2]/div[2]/div/div/div[2]/table/tbody/tr[2]/td[2]/div")).getText());
    {
