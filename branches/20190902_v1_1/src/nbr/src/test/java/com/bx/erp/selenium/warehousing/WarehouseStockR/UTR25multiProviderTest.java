...
import java.util.*;
public class UTR25multiProviderTest {
  ...
  @Test
  public void uTR25multiProvider() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".layui-icon-search")).click();
    {
      ...
      wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("otherProvider")));
    }
    driver.findElement(By.linkText("更多")).click();
    {
      WebDriverWait wait = new WebDriverWait(driver, 1);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("otherProvider")));
    }
    driver.close();
  }
}
