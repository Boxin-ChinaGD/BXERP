...
import java.util.*;
public class UTR30searchWhenNoCommoditys2Test {
  ...
  @Test
  public void uTR30searchWhenNoCommoditys2() {
    LoginSucceed();
    ...
    driver.findElement(By.linkText("粮油副食")).click();
    driver.findElement(By.linkText("酱菜罐头")).click();
