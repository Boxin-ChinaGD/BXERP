...
import java.util.*;
public class UTR3queryRetailSheetByPayWayTest {
  ...
  @Test
  public void uTR3queryRetailSheetByPayWay() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".pattern li:nth-child(2)")).getText(), is("现金支付"));
    ...
    driver.findElement(By.cssSelector(".pattern > .layui-form-label label")).click();
    assertThat(driver.findElement(By.cssSelector(".pattern li:nth-child(1)")).getText(), is("所有"));
    driver.findElement(By.cssSelector(".pattern li:nth-child(1)")).click();
