...
import java.util.*;
public class UTR4queryRetailSheetByStaffTest {
  ...
  @Test
  public void uTR4queryRetailSheetByStaff() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".layui-inline:nth-child(1) li:nth-child(8)")).click();
    vars.put("counts2", driver.findElement(By.cssSelector(".layui-laypage-count")).getText());
    driver.findElement(By.cssSelector(".layui-inline:nth-child(1) > .layui-form-label label")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-inline:nth-child(1) li:nth-child(1)")).getText(), is("所有"));
