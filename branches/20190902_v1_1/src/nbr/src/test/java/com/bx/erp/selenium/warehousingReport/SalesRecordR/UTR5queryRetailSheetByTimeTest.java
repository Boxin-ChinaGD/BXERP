...
import java.util.*;
public class UTR5queryRetailSheetByTimeTest {
  ...
  @Test
  public void uTR5queryRetailSheetByTime() {
    LoginSucceed();
    ...
    driver.findElement(By.cssSelector(".sell > .layui-form-label label")).click();
    assertThat(driver.findElement(By.cssSelector(".sell li:nth-child(1)")).getText(), is("所有"));
    driver.findElement(By.cssSelector(".sell li:nth-child(1)")).click();
