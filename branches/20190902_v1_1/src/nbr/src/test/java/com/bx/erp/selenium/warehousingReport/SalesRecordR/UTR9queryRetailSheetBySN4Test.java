...
import java.util.*;
public class UTR9queryRetailSheetBySN4Test {
  ...
  @Test
  public void uTR9queryRetailSheetBySN4() {
    LoginSucceed();
...
//    System.out.println("销售记录的条数为：vars.get("counts").toString()");
    ...
    driver.findElement(By.xpath("//div[@id=\'purchasingOrderMain\']/div/div/div[4]/input")).sendKeys("LS201909130273873615243678987");
    driver.findElement(By.cssSelector(".layui-icon")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("单据流水号长度不能大于26,且不能够小于10个字符"));
    driver.close();
  }
}
