...
import com.bx.erp.action.trade.promotion.CashReducingOfAmount;
...
@WebAppConfiguration
public class CashReducingOfAmountTest extends BaseActionTest {
	...
	public void promoteNewTest() throws Exception {
		...
		System.out.println("-------------------------------Case1：三个活动都为指定满减------------------------------------");
		// 创建一个折扣满减活动A, 放到缓存里
		Promotion promotionA = BasePromotionTest.DataInput.getPromotion();
		promotionA.setID(1);
		promotionA.setType(EnumTypePromotion.ETP_DecreaseOnAmount.getIndex());
		promotionA.setScope(1);
		promotionA.setStatus(0);
		promotionA.setName("指定商品满10-1");
		promotionA.setExcecutionThreshold(10);
		promotionA.setExcecutionAmount(1);
		...
		promotionB.setID(2);
		promotionB.setType(EnumTypePromotion.ETP_DecreaseOnAmount.getIndex());
		promotionB.setScope(1);
		promotionB.setStatus(0);
		promotionB.setName("指定商品满20-4");
		promotionB.setExcecutionThreshold(20);
		...
		promotionC.setID(3);
		promotionC.setType(EnumTypePromotion.ETP_DecreaseOnAmount.getIndex());
		promotionC.setScope(1);
		promotionC.setStatus(0);
		promotionC.setName("指定商品满10000-1000");
		promotionC.setExcecutionThreshold(10000);
		promotionC.setExcecutionAmount(1000);
		promotionC.setExcecutionDiscount(0.8);
		...
		rtc2.setBarcodeID(1);
		rtc2.setNO(5);
		rtc2.setOperatorStaffID(STAFF_ID1);
		...
		rtc3.setBarcodeID(1);
		rtc3.setNO(4);
		rtc3.setOperatorStaffID(STAFF_ID1);
		...
		rtc4.setBarcodeID(1);
		rtc4.setNO(5);
		rtc4.setOperatorStaffID(STAFF_ID1);
		...
		rtc5.setBarcodeID(1);
		rtc5.setNO(10);
		rtc5.setOperatorStaffID(STAFF_ID1);
		...
		rtc6.setBarcodeID(1);
		rtc6.setNO(2);
		rtc6.setOperatorStaffID(STAFF_ID1);
		...
		rtc7.setBarcodeID(1);
		rtc7.setNO(14);
		rtc7.setOperatorStaffID(STAFF_ID1);
		...
		rtc8.setBarcodeID(1);
		rtc8.setOperatorStaffID(STAFF_ID1);
		...
		rtc9.setBarcodeID(1);
		rtc9.setOperatorStaffID(STAFF_ID1);
		...
		rtc10.setNO(11);
		rtc10.setOperatorStaffID(STAFF_ID1);
		...
		rtCreate.setAmount(coa.getOriginalTotalAmount(rtCreate, Shared.DBName_Test));
		...
		for (Object o : rtCreate.getListSlave1()) {
			...
			System.out.println("此单原价：" + coa.getOriginalTotalAmount(rtCreate, Shared.DBName_Test) + "--实际支付价格：" + rtCreate.getAmount() + "--商品原价：" + rtc.getPriceOriginal() + "--退货价：" + rtc.getPriceReturn());
		}
		coa.promote(rtCreate, EnumPromotionScope.EPS_SpecifiedCommodities, CacheManager.getCache(Shared.DBName_Test, EnumCacheType.ECT_Promotion).readN(false, false), Shared.DBName_Test);
		System.out.println("-----------------------------确认支付价格后-----------------------------------------------------------------------------------------------------------");
		for (Object o : rtCreate.getListSlave1()) {
			RetailTradeCommodity rtc = (RetailTradeCommodity) o;
			System.out.println("此单原价：" + coa.getOriginalTotalAmount(rtCreate, Shared.DBName_Test) + "--实际支付价格：" + rtCreate.getAmount() + "--商品原价：" + rtc.getPriceOriginal() + "--退货价：" + rtc.getPriceReturn());
		}
		RetailTrade rtNew = coa.getRetailTrade();
	...
	public void promoteNewTest2() throws Exception {
		...
		cal.set(2019, 12 - 1, 12);
		Date endDatetime = cal.getTime();
		System.out.println("-------------------------------Case2：三个活动都为全场满减------------------------------------");
		// 创建一个折扣满减活动A, 放到缓存里
		Promotion promotionA = BasePromotionTest.DataInput.getPromotion();
		promotionA.setID(1);
		promotionA.setType(EnumTypePromotion.ETP_DecreaseOnAmount.getIndex());
		...
		promotionA.setStatus(0);
		promotionA.setName("全场商品满100-50");
		promotionA.setExcecutionThreshold(100);
		promotionA.setExcecutionAmount(50);
		promotionA.setDatetimeStart(startDatetime);
		promotionA.setDatetimeEnd(endDatetime);
		CacheManager.getCache(Shared.DBName_Test, EnumCacheType.ECT_Promotion).write1(promotionA, Shared.DBName_Test, staff.getID());
		// 创建一个满折活动B
		...
		promotionC.setStatus(0);
		promotionC.setName("全场商品满5000-1000");
		promotionC.setExcecutionThreshold(5000);
		promotionC.setExcecutionAmount(1000);
		promotionC.setExcecutionDiscount(0.8);
		promotionC.setDatetimeStart(startDatetime);
		promotionC.setDatetimeEnd(endDatetime);
		...
		for (Object o : rtCreate.getListSlave1()) {
			RetailTradeCommodity rtc = (RetailTradeCommodity) o;
			System.out.println("此单原价：" + coa.getOriginalTotalAmount(rtCreate, Shared.DBName_Test) + "--实际支付价格：" + rtCreate.getAmount() + "--商品原价：" + rtc.getPriceOriginal() + "--商品数量：" + rtc.getNO() + "--退货价：" + rtc.getPriceReturn());
		}
		coa.promote(rtCreate, EnumPromotionScope.EPS_AllCommodities, CacheManager.getCache(Shared.DBName_Test, EnumCacheType.ECT_Promotion).readN(false, false), Shared.DBName_Test);
		System.out.println("-----------------------------确认支付价格后-----------------------------------------------------------------------------------------------------------");
		for (Object o : rtCreate.getListSlave1()) {
			RetailTradeCommodity rtc = (RetailTradeCommodity) o;
			System.out.println("此单原价：" + coa.getOriginalTotalAmount(rtCreate, Shared.DBName_Test) + "--实际支付价格：" + rtCreate.getAmount() + "--商品原价：" + rtc.getPriceOriginal() + "--商品数量：" + rtc.getNO() + "--退货价：" + rtc.getPriceReturn());
	...
	public void promoteNewTest4() throws Exception {
		...
		cal.set(2019, 12 - 1, 12);
		Date endDatetime = cal.getTime();
		System.out.println("-------------------------------Case4:一个全场活动 归零------------------------------------");
		// 创建一个全场满减活动C
		Promotion promotionC = BasePromotionTest.DataInput.getPromotion();
		promotionC.setID(2);
		promotionC.setType(EnumTypePromotion.ETP_DecreaseOnAmount.getIndex());
		promotionC.setScope(0);
		promotionC.setStatus(0);
		promotionC.setName("全场商品满276-276");
		promotionC.setExcecutionThreshold(276);
		promotionC.setExcecutionAmount(276);
		promotionC.setExcecutionDiscount(0.8);
		promotionC.setDatetimeStart(startDatetime);
		promotionC.setDatetimeEnd(endDatetime);
		CacheManager.getCache(Shared.DBName_Test, EnumCacheType.ECT_Promotion).write1(promotionC, Shared.DBName_Test, staff.getID());
		...
		// 创建一个零售单
		RetailTradeCommodityMapper retailTradeCommodityMapper = (RetailTradeCommodityMapper) applicationContext.getBean("retailTradeCommodityMapper");
