...
public class BrandSyncThread1 extends BaseSyncSITTestThread1 {
	protected final String SyncActionRetrieveNExURL = "/brandSync/retrieveNEx.bx";
	...
	protected String getSyncActionFeedbackExURL(String objIDs, String errorCode) {
		String SyncActionFeedbackExURL = "/brandSync/feedbackEx.bx?sID=" + objIDs + "&errorCode=" + errorCode;
	 ...
	 * @param iSyncBlockNO
	 *            要同步的块的总数，即同步表主表总行数 */
	public BrandSyncThread1(MockMvc mvc, HttpSession session, int iPhase, int iPosNO, int iSyncBlockNO) {
