...
public class PosTest extends BaseAndroidTestCase {
    @BeforeClass
    public void setUp() {
    ...
    public void test_f_FromJson() throws JSONException {
        ...
        JSONObject json = new JSONObject(gson.toJson(p));
        ...
        p2.setPasswordInPOS("");
        JSONObject json2 = new JSONObject(gson.toJson(p2));
        ...
        JSONObject json3 = new JSONObject(gson.toJson(p3));
