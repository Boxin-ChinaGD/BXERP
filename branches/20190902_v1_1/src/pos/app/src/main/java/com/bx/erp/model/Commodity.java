...
//@Entity(nameInDb = COMMODITY_TABLE_NAME)
...
//    public static final double PURCHASING_PRICE_START_Default = -1.000000d;
    ...
    @NotNull
    @Property(nameInDb = "F_ShortName")
    protected String shortName;

    @NotNull
    @Property(nameInDb = "F_Specification")
    protected String specification;

    @Property(nameInDb = "F_PackageUnitID")
    protected int packageUnitID;

    @Property(nameInDb = "F_PurchasingUnit")
    protected String purchasingUnit;

    @Property(nameInDb = "F_BrandID")
    protected int brandID;

    @Property(nameInDb = "F_CategoryID")
    protected int categoryID;

    @NotNull
    @Property(nameInDb = "F_MnemonicCode")
    protected String mnemonicCode;

    @NotNull
    @Property(nameInDb = "F_PricingType")
    ...
    @NotNull
    @Property(nameInDb = "F_PriceVIP")
    protected double priceVIP;

    @NotNull
    @Property(nameInDb = "F_PriceWholesale")
    protected double priceWholesale;

    @NotNull
    @Property(nameInDb = "F_CanChangePrice")
    protected int canChangePrice;

    @NotNull
    @Property(nameInDb = "F_RuleOfPoint")
    protected int ruleOfPoint;

    @NotNull
    @Property(nameInDb = "F_Picture")
    ...
    @NotNull
    @Property(nameInDb = "F_ReturnDays")
    ...
    @NotNull
    @Property(nameInDb = "F_PurchaseFlag")
    protected int purchaseFlag;

    @NotNull
    @Property(nameInDb = "F_RefCommodityID")
    protected int refCommodityID;

    @NotNull
    @Property(nameInDb = "F_RefCommodityMultiple")
    protected int refCommodityMultiple;

    @NotNull
    @Property(nameInDb = "F_Tag")
    ...
    @Property(nameInDb = "F_StartValueRemark")
    protected String startValueRemark;

    @Property(nameInDb = "F_PropertyValue1")
    protected String propertyValue1;

    @Property(nameInDb = "F_PropertyValue2")
    protected String propertyValue2;

    @Property(nameInDb = "F_PropertyValue3")
    protected String propertyValue3;

    @Property(nameInDb = "F_PropertyValue4")
...
//            propertyValue4 = jo.getString("propertyValue4");
            ...
            for (int i = 0; i < jrCommShopSlave.length(); i++) {
    ...
    public BaseModel parse1C(String s) {
        ...
        JSONObject jo = null;
        try {
            return doParse1C(new JSONObject(s));
        } catch (JSONException e) {
            e.printStackTrace();
    ...
    public BaseModel doParse1C(JSONObject jo) {
        ...
        try {
            ...
            brandID = jo.getInt(field.getFIELD_NAME_brandID());
            canChangePrice = jo.getInt(field.getFIELD_NAME_canChangePrice());
            categoryID = jo.getInt(field.getFIELD_NAME_categoryID());
            latestPricePurchase = jo.getDouble(field.getFIELD_NAME_latestPricePurchase());
            mnemonicCode = jo.getString(field.getFIELD_NAME_mnemonicCode());
            nOStart = jo.getInt(field.getFIELD_NAME_nOStart());
...
//            pricePurchase = Double.parseDouble(jo.getString(getFIELD_NAME_pricePurchase()));
            ...
            priceVIP = jo.getDouble(field.getFIELD_NAME_priceVIP());
            priceWholesale = jo.getDouble(field.getFIELD_NAME_priceWholesale());
            pricingType = jo.getInt(field.getFIELD_NAME_pricingType());
            purchaseFlag = jo.getInt(field.getFIELD_NAME_purchaseFlag());
            purchasingPriceStart = jo.getDouble(field.getFIELD_NAME_purchasingPriceStart());
            purchasingUnit = jo.getString(field.getFIELD_NAME_purchasingUnit());
            refCommodityID = jo.getInt(field.getFIELD_NAME_refCommodityID());
            refCommodityMultiple = jo.getInt(field.getFIELD_NAME_refCommodityMultiple());
            returnDays = jo.getInt(field.getFIELD_NAME_returnDays());
            ruleOfPoint = jo.getInt(field.getFIELD_NAME_ruleOfPoint());
            shelfLife = jo.getInt(field.getFIELD_NAME_shelfLife());
            shortName = jo.getString(field.getFIELD_NAME_shortName());
            specification = jo.getString(field.getFIELD_NAME_specification());
            status = jo.getInt(field.getFIELD_NAME_status());
//            int2 = jo.getInt(getFIELD_NAME_int2());
