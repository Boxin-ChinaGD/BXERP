...
public class Promotion extends BaseModel {
    ...
    @Transient
    public static final String HTTP_Promotion_RetrieveNC = "promotion/retrieveNEx.bx";
    @Transient
...
//    protected Date approveDatetime;
    ...
    @NotNull
    @Property(nameInDb = "F_DatetimeStart")
    protected Date datetimeStart;

    @NotNull
    @Property(nameInDb = "F_DatetimeEnd")
...
//    @Property(nameInDb = "F_ExecuteWeekday")
//    @Transient
//    protected String executeWeekday;


//    @Property(nameInDb = "F_ExecuteStartDatetime")
//@Transient
//    protected Date executeStartDatetime;

//    @Property(nameInDb = "F_ExecuteEndDatetime")
//@Transient
...
//    @Property(nameInDb = "F_DiscountUponVIP")
//@Transient
//    protected String discountUponVIP;

//    @Property(nameInDb = "F_SpecialOfferInvolved")
//@Transient
//    protected String specialOfferInvolved;


//    @Property(nameInDb = "F_Times")
//@Transient
//    protected String times;


//    @Property(nameInDb = "F_VIPBornDayOrMonth")
//@Transient
//    protected String vIPBornDayOrMonth;

//    @Property(nameInDb = "F_WholeShop")
//@Transient
//    protected String wholeShop;


//    @Property(nameInDb = "F_NOReached")
//    @Transient
//    protected String NOReached;

//    @Property(nameInDb = "F_AmountReached")
//    @Transient
//    protected String amountReached;

////    @Property(nameInDb = "F_CashExcluded")
//    @Transient
//    protected String cashExcluded;

//    @Property(nameInDb = "F_WholeTradeDiscount")
//@Transient
//    protected String wholeTradeDiscount;

    @NotNull
    @Property(nameInDb = "F_ExcecutionDiscount")
    protected double excecutionDiscount;

//    @Property(nameInDb = "F_NOComputationInvolved")
//@Transient
//    protected String NOComputationInvolved;

////    @Property(nameInDb = "F_GiftAll")
//@Transient
//    protected String giftAll;

////    @Property(nameInDb = "F_NODoubled")
//    @Transient
//    protected String NODoubled;

////    @Property(nameInDb = "F_AmountComputationInvolved")
//@Transient
//    protected String amountComputationInvolved;

    @NotNull
    @Property(nameInDb = "F_ExcecutionThreshold")
    protected double excecutionThreshold;

    @NotNull
    @Property(nameInDb = "F_ExcecutionAmount")
    protected Double excecutionAmount;

    @NotNull
    @Property(nameInDb = "F_Scope")
    protected int scope;

    @NotNull
    @Property(nameInDb = "F_Staff")
    protected int staff;

//    @Property(nameInDb = "F_DiscountInvolvedForSpecialOffer")
...
//    }
    ...
    public BaseModel parse1(String s) {
        ...
        try {
            JSONObject joP = new JSONObject(s);
    ...
    public List<?> parseN(JSONArray jsonArray) {
        ...
        List<BaseModel> pList = new ArrayList<>();
        try {
