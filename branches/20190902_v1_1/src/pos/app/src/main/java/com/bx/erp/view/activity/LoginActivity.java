...
//                            tvLogin.setClickable(true);
//                            Intent noNet_login_intent = new Intent(LoginActivity.this, SyncDataActivity.class);
...
//                        username.setText("");
//                        password.setText("");
//                        Intent login_intent = new Intent(LoginActivity.this, PreSaleActivity.class);
//                        LoginActivity.this.finish();
//                        startActivity(login_intent);
//                    } else {
//                        username.setText("");
//                        password.setText("");
//                        Intent login_intent = new Intent(LoginActivity.this, SyncDataActivity.class);
