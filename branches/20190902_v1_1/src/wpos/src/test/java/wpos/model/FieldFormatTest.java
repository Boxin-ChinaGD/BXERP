...
public class FieldFormatTest {
    ...
    @Test
    public void checkInventorySheetRemark() {
    ...
    @Test
    public void checkPriceWholesale() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfMultiPackagingType() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfServiceType() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfMultiPackagingStatus() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfMultiPackagingBarcodes() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfMultiPackagingNO() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfMultiiaPriceRetail() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfCompositionPurchaseFlag() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfCompositionShelfLife() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfCompositionRuleOfPoint() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkIfCompositionType() {
        Shared.printTestMethodStartInfo();
        //
    ...
    @Test
    public void checkCompanyAppField() {
        Shared.printTestMethodStartInfo();
    ...
    @Test
    public void checkRetailTradeRetrieveNBySN() {
        Shared.printTestMethodStartInfo();
        // 从app发出的请求，其queryKeyword代表SN，只根据SN来查询
        // 空串
        Assert.assertTrue(FieldFormat.checkRetailTradeRetrieveNBySN(""));
    ...
    public void checkPayAmount() {
        Shared.printTestMethodStartInfo();
        Assert.assertTrue(FieldFormat.checkPayAmount("0."));
        Assert.assertTrue(FieldFormat.checkPayAmount("1."));
        Assert.assertTrue(FieldFormat.checkPayAmount("0.01"));
        Assert.assertTrue(FieldFormat.checkPayAmount("99.98"));
        Assert.assertTrue(FieldFormat.checkPayAmount("0.00"));
        Assert.assertTrue(FieldFormat.checkPayAmount("0"));
        Assert.assertTrue(FieldFormat.checkPayAmount("99.99"));
        Assert.assertTrue(FieldFormat.checkPayAmount("33.3"));
        Assert.assertTrue(FieldFormat.checkPayAmount("78"));
        Assert.assertTrue(FieldFormat.checkPayAmount("0.80"));
        Assert.assertTrue(FieldFormat.checkPayAmount("99.01"));
        Assert.assertTrue(FieldFormat.checkPayAmount("0.9"));
        Assert.assertTrue(FieldFormat.checkPayAmount("0.01"));
        Assert.assertTrue(FieldFormat.checkPayAmount("0"));
        Assert.assertTrue(FieldFormat.checkPayAmount("1."));
        Assert.assertTrue(FieldFormat.checkPayAmount("0.01"));
        ...
        Assert.assertTrue(FieldFormat.checkPayAmount("0.00"));
        Assert.assertTrue(FieldFormat.checkPayAmount("0"));
        Assert.assertTrue(FieldFormat.checkPayAmount("65535"));
        Assert.assertTrue(FieldFormat.checkPayAmount("0000000000"));
        //
        Assert.assertFalse(FieldFormat.checkPayAmount("-0.00"));
        Assert.assertFalse(FieldFormat.checkPayAmount("-0.01"));
        Assert.assertFalse(FieldFormat.checkPayAmount("%"));
        Assert.assertFalse(FieldFormat.checkPayAmount("$"));
        Assert.assertFalse(FieldFormat.checkPayAmount("A"));
        Assert.assertFalse(FieldFormat.checkPayAmount("；"));
        Assert.assertFalse(FieldFormat.checkPayAmount("0.001"));
        Assert.assertFalse(FieldFormat.checkPayAmount("99.9901"));
        Assert.assertFalse(FieldFormat.checkPayAmount("-0.01"));
        Assert.assertFalse(FieldFormat.checkPayAmount("%"));
        Assert.assertFalse(FieldFormat.checkPayAmount("$"));
        Assert.assertFalse(FieldFormat.checkPayAmount("A"));
