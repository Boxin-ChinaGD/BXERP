SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_Case11.sql+++++++++++++++++++++++';

SELECT '-----------------Case11:员工A,B上班进行售卖，员工A退B当天的货。------------------' AS 'Case11';
-- 插入商品
...
SET @rt1CommotidyPrice1_B = 18.320000;
SET @rt1AmuontCash_B = 183.200000;
SET @rt1AmuontWeChat_B = 0.000000;
SET @rt1AmuontAliPay_B = 0.000000;
SET @rt1TotalAmount_B = @rt1CommotidyNO1_B * @rt1CommotidyPrice1_B;
-- 
SET @rt1CommotidyNO1_A = 10;
SET @rt1CommotidyPrice_A = 18.320000;
SET @rt1AmuontCash_A = 183.200000;
SET @rt1AmuontWeChat_A = 0.000000;
SET @rt1AmuontAliPay_A = 0.000000;
SET @rt1TotalAmount_A = @rt1CommotidyNO1_A * @rt1CommotidyPrice_A;
-- 退货单(退零售单1)
SET @rrt1CommotidyNO_B = 10;
SET @rrt1CommotidyPrice_B = 18.320000;
SET @rrt1AmuontCash_B = 183.200000;
...
-- 零售单收银汇总
-- 店员A
SET @rggWorkTimeStart_A='3030-02-28 00:00:00';
SET @rggWorkTimeEnd_A='3030-02-28 23:59:59';
...
SET @rggNO_A = 1;
-- 店员B
SET @rggWorkTimeStart_B='3030-02-28 00:00:00';
SET @rggWorkTimeEnd_B='3030-02-28 23:59:59';
...
VALUES (@iStaffIDA, 2, @rggWorkTimeStart_A, @rggWorkTimeEnd_A, @rggNO_A, @rggTotalAmount_A, 183.200000, @rggTotalAmountCash_A, @rggTotalAmountWeChat_A, @rggTotalAmountAliPay_A, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, now());
SET @rtgID1_A = last_insert_id();
INSERT INTO t_retailtradeaggregation (F_StaffID, F_PosID, F_WorkTimeStart, F_WorkTimeEnd, F_TradeNO, F_Amount, F_ReserveAmount, F_CashAmount, F_WechatAmount, F_AlipayAmount, F_Amount1, F_Amount2, F_Amount3, F_Amount4, F_Amount5, F_UploadDateTime)
VALUES (@iStaffIDB, 2, @rggWorkTimeStart_B, @rggWorkTimeEnd_B, @rggNO_B, @rggTotalAmount_B, 183.200000, @rggTotalAmountCash_B, @rggTotalAmountWeChat_B, @rggTotalAmountAliPay_B, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, now());
...
VALUES (1,'LS3030020100000500010001',11068,4,'url=ashasoadigmnalskd','3030/02/28 06:00:00',@iStaffIDB,1,'0',1,'…',-1,'3030/02/28 06:00:00',@rt1TotalAmount_B,@rt1AmuontCash_B,@rt1AmuontAliPay_B,@rt1AmuontWeChat_B,0.000000,0.000000,0.000000,0.000000,0.000000,1,NULL,NULL,NULL,NULL,NULL,NULL,2);
SET @rtID1_B = last_insert_id();
INSERT INTO t_retailtrade (F_VipID, F_SN, F_LocalSN, F_POS_ID, F_Logo, F_SaleDatetime, F_StaffID, F_PaymentType, F_PaymentAccount, F_Status, F_Remark, F_SourceID, F_SyncDatetime, F_Amount, F_AmountCash, F_AmountAlipay, F_AmountWeChat, F_Amount1, F_Amount2, F_Amount3, F_Amount4, F_Amount5, F_SmallSheetID, F_AliPayOrderSN, F_WxOrderSN, F_WxTradeNO, F_WxRefundNO, F_WxRefundDesc, F_WxRefundSubMchID, F_ShopID)
VALUES (1,'LS3030020100000500010001_1',11069,5,'url=ashasoadigmnalskd','3030/02/28 07:00:01',@iStaffIDA,1,'0',1,'…',@rtID1_B,'3030/02/28 07:00:01',@rrt1TotalAmount_B,@rrt1AmuontCash_B,@rrt1AmuontAliPay_B,@rrt1AmuontWeChat_B,0.000000,0.000000,0.000000,0.000000,0.000000,1,NULL,NULL,NULL,NULL,NULL,NULL,2);
SET @rrtID1_B = last_insert_id();
INSERT INTO t_retailtrade (F_VipID, F_SN, F_LocalSN, F_POS_ID, F_Logo, F_SaleDatetime, F_StaffID, F_PaymentType, F_PaymentAccount, F_Status, F_Remark, F_SourceID, F_SyncDatetime, F_Amount, F_AmountCash, F_AmountAlipay, F_AmountWeChat, F_Amount1, F_Amount2, F_Amount3, F_Amount4, F_Amount5, F_SmallSheetID, F_AliPayOrderSN, F_WxOrderSN, F_WxTradeNO, F_WxRefundNO, F_WxRefundDesc, F_WxRefundSubMchID, F_ShopID)
VALUES (1,'LS3030020100000500010002',11068,6,'url=ashasoadigmnalskd','3030/02/28 09:00:00',@iStaffIDA,1,'0',1,'…',-1,'3030/02/28 09:00:00',@rt1TotalAmount_A,@rt1AmuontCash_A,@rt1AmuontAliPay_A,@rt1AmuontWeChat_A,0.000000,0.000000,0.000000,0.000000,0.000000,1,NULL,NULL,NULL,NULL,NULL,NULL,2);
SET @rtID1_A = last_insert_id();

-- 插入零售单商品表
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rtID1_B,@iCommodityID1,'长虹剑',245,@rt1CommotidyNO1_B,18.320000,10,@rt1CommotidyPrice1_B,NULL,18.320000);
...
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rtID1_A,@iCommodityID1,'长虹剑',245,@rt1CommotidyNO1_A,18.320000,10,@rt1CommotidyPrice_A,NULL,18.320000);
...
SET @iErrorCode = 0;
SET @sErrorMsg = '';
SET @dSaleDatetime = '3030-02-28 00:00:00';
...
-- 售卖总金额
SET @saleTotalAmount_A = (@rt1CommotidyNO1_A * @rt1CommotidyPrice_A);
-- 售卖商品总成本
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification1 = 1,'测试成功','测试失败') AS 'Test Case11 Result';


-- 售卖总金额
SET @saleTotalAmount_B = @rt1CommotidyNO1_B * @rt1CommotidyPrice1_B;
-- 售卖商品总成本
SET @saleTotalCost_B = (@rtcs1NO_B * (SELECT F_Price FROM t_warehousingcommodity WHERE F_WarehousingID = @rtcs1WarehousingID_B AND F_CommodityID = @commodityID216));
-- 售卖商品总毛利
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification2 = 1,'测试成功','测试失败') AS 'Test Case11 Result';
...
DELETE FROM t_retailtradecommodity WHERE F_TradeID IN (@rtID1_B,@rrtID1_B,@rtID1_A);
DELETE FROM t_retailtrade WHERE F_ID IN (@rtID1_B,@rrtID1_B,@rtID1_A);
