SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case16.sql+++++++++++++++++++++++';

SELECT '----- case16:  员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应一个入库单 [A] -------' AS 'Case16';
-- 
SET @rt1CommotidyNO1 = 100;
SET @rt1CommotidyPrice1 = 200;
SET @rt1CommotidyNO2 = 500;
SET @rt1CommotidyPrice2 = 300;
SET @rt1AmuontCash = @rt1CommotidyNO1 * @rt1CommotidyPrice1 + @rt1CommotidyNO2 * @rt1CommotidyPrice2;-- 170000.000000;
SET @rt1AmuontWeChat = 0.000000;
SET @rt1AmuontAliPay = 0.000000;
SET @rt1TotalAmount = @rt1AmuontCash + @rt1AmuontWeChat + @rt1AmuontAliPay; -- @rt1CommotidyNO1 * @rt1CommotidyPrice1 + @rt1CommotidyNO2 * @rt1CommotidyPrice2;
-- 零售单收银汇总
...
-- 
SET @warehousingBCommodityNO3=500;
SET @warehousingBCommodityPrice3=10;
...
-- 创建B的一个条形码
INSERT INTO t_barcodes (F_CommodityID, F_Barcode, F_CreateDatetime, F_UpdateDatetime)
VALUES (@commIDB, 'tzq77777', '2119-01-01 09:00:00', '2119-01-01 09:00:00');
...
-- 插入入库单商品表
INSERT INTO t_warehousingcommodity (F_WarehousingID, F_CommodityID, F_NO, F_PackageUnitID, F_CommodityName, F_BarcodeID, F_Price, F_Amount, F_ProductionDatetime, F_ShelfLife, F_ExpireDatetime, F_CreateDatetime, F_UpdateDatetime, F_NOSalable)
VALUES (@warehouseB1, @commIDB, @warehousingBCommodityNO3, 3, '跨库商品B', @barcodeIDB, @warehousingBCommodityPrice3, 5000, '2119-01-01 06:00:00', 36, '2119-01-09 06:00:00', '2119-01-01 06:00:00', '2119-01-01 06:00:00', 5);
...
VALUES (@staffIDA, 2, @rggWorkTimeStart1, @rggWorkTimeEnd1, @rggNO1, @rggTotalAmount1, 170000.000000, @rggTotalAmountCash1, @rt1AmuontWeChat, @rggTotalAmountAliPay1, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, now());
...
VALUES (@rtID1, @commIDA, '普通商品A', @barcodeIDA, @rt1CommotidyNO2, 20, 500, @rt1CommotidyPrice2, 300, NULL);
...
-- 零售商品B
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rtID1, @commIDB, '普通商品B', @barcodeIDB, @rt1CommotidyNO1, 254, 100, @rt1CommotidyPrice1, 200, NULL);
...
-- 售卖总金额
SET @saleTotalAmount = (@rt1CommotidyNO1 * @rt1CommotidyPrice1 + @rt1CommotidyNO2 * @rt1CommotidyPrice2);
-- 售卖商品总成本
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification1 = 1,'测试成功','测试失败') AS 'Test Case16 Result';
-- 
