SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case17.sql+++++++++++++++++++++++';

SELECT '----- case17: 员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应两个入库单 [A]  -------' AS 'Case17';
-- 
SET @rt1CommotidyNO1 = 500;
SET @rt1CommotidyPrice1 = 300;
SET @rt1CommotidyNO2 = 100;
SET @rt1CommotidyPrice2 = 200;
SET @rt1AmuontCash = 170000.000000;
...
-- 零售单商品来源表
SET @rtcs1NO = 200;
SET @rtcs2NO = @rt1CommotidyNO1 - @rtcs2NO;
SET @rtcs3NO = 50;
...
INSERT INTO t_commodity (F_Status, F_Name, F_ShortName, F_Specification, F_PackageUnitID, F_PurchasingUnit, F_BrandID, F_CategoryID, F_MnemonicCode, F_PricingType, 
F_PriceVIP, F_PriceWholesale, F_CanChangePrice, F_RuleOfPoint, F_ShelfLife, F_ReturnDays, F_CreateDate, F_PurchaseFlag, F_RefCommodityID, F_RefCommodityMultiple, F_Tag, F_Type, F_CreateDatetime, F_UpdateDatetime)
VALUES (0, '跨库商品B', '普通商品B', '个', 3, '包', 1, 1, 'TZQ666', 1, 
19, 19, 0, 1, 365, 3, '2119-01-01 09:00:00', 1, 0, 0, 0, 0, '2119-01-01 09:00:00', '2019-05-19 09:00:00');
...
VALUES (@staffIDA, 2, @rggWorkTimeStart1, @rggWorkTimeEnd1, @rggNO1, @rggTotalAmount1, 170000.000000, @rggTotalAmountCash1, @rggTotalAmountWeChat1, @rggTotalAmountAliPay1, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, now());
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification1 = 1,'测试成功','测试失败') AS 'Test Case17 Result';
-- 
