...
SELECT '----- case21:员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应两个入库单 , C商品，对应两个入库单,一张退货单，对商品A、B全部退货, [A]-------' AS 'Case21';
-- 收银员
SET @staffID_A = 9;
...
SET @warehousingCommodityA_Price1 = 9.999999; -- 入库单1
SET @warehousingCommodityA_NO1 = 500;
SET @warehousingCommodityA_Price2 = 8.888888; -- 入库单2
SET @warehousingCommodityA_NO2 = 1000;
SET @commodityPriceB = 220;
SET @warehousingCommodityB_Price1 = 7.777777;
SET @warehousingCommodityB_NO1 = 500;
SET @warehousingCommodityB_Price2 = 6.666666;
SET @warehousingCommodityB_NO2 = 1000;
SET @commodityPriceC = 770;
SET @warehousingCommodityC_Price1 = 5.555555;
SET @warehousingCommodityC_NO1 = 500;
SET @warehousingCommodityC_Price2 = 4.444444;
...
SET @rrt1TotalAmount_A = (@rrt1CommotidyNO1_A + @rrt1CommotidyNO2_A) * @rt1CommotidyPrice_A -- 
...
SET @rggTotalAmount_A = @rt1TotalAmount_A - @rrt1TotalAmount_A; 
SET @rggTotalAmountCash_A = @rt1AmuontCash_A - @rt1AmuontCash_A;
...
VALUES (1,'LS2041020200000500010001_1',11069,1,'url=ashasoadigmnalskd',@rrt1SaleDatetimeB,@staffID_A,1,'0',1,'…',@rtIDA,@rrt1SaleDatetimeB,@rrt1TotalAmount_A,@rrt1AmuontCash_A,@rrt1AmuontAliPay_A,@rrt1AmuontWeChat_A,0.000000,0.000000,0.000000,0.000000,0.000000,1,NULL,NULL,NULL,NULL,NULL,NULL,2);
...
SELECT IF(@totalAmountA = (@rt1TotalAmount_A - @rrt1TotalAmount_A), '测试成功', '测试失败') AS 'Case21.3 Testing Result';
-- 
...
SET @saleGrossMargin = @rt1TotalAmount_A - (@rt1CommotidyNO1_A * @warehousingCommodityA_Price1) - (@rt1CommotidyNO2_A * @warehousingCommodityA_Price2) -- 
					...
					- (@rt1CommotidyNO1_C * @warehousingCommodityC_Price1) - (@rt1CommotidyNO2_C * @warehousingCommodityC_Price2); -- 销售毛利
SET @returnGrossMargin = @rrt1TotalAmount_A - (@rrt1CommotidyNO1_A * @warehousingCommodityA_Price1) - (@rrt1CommotidyNO2_A * @warehousingCommodityA_Price2) -- 
					 - (@rrt1CommotidyNO1_B * @warehousingCommodityB_Price1) - (@rrt1CommotidyNO2_B * @warehousingCommodityB_Price2); -- 退货毛利
SELECT IF(@grossMargin = @saleGrossMargin - @returnGrossMargin, '测试成功', '测试失败') AS 'Case21.5 Testing Result';
-- 
