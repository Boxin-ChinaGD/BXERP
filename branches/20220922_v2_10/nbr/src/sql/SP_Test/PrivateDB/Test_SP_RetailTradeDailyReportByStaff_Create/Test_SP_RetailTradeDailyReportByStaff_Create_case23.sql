SELECT '++++++++++++++++++Test_SP_RetailTradeDailyReportByStaff_Create_case23.sql+++++++++++++++++++++++';


SELECT '----- case23:员工A创建一个零售单卖A商品，对应两个入库单 ,B商品，对应两个入库单 , C商品，对应两个入库单,员工B创建一张退货单，对商品A、B全部退货[AB]-------' AS 'Case23';
-- 收银员
SET @staffID_A = 9;
SET @staffID_B = 10;
...
SET @warehousingCommodityA_Price1 = 9.100001; -- 入库单1
SET @warehousingCommodityA_NO1 = 500;
SET @warehousingCommodityA_Price2 = 8.200002; -- 入库单2
SET @warehousingCommodityA_NO2 = 1000;
SET @commodityPriceB = 220;
SET @warehousingCommodityB_Price1 = 7.300003;
SET @warehousingCommodityB_NO1 = 500;
SET @warehousingCommodityB_Price2 = 6.400004;
SET @warehousingCommodityB_NO2 = 1000;
SET @commodityPriceC = 770;
SET @warehousingCommodityC_Price1 = 5.500005;
SET @warehousingCommodityC_NO1 = 500;
SET @warehousingCommodityC_Price2 = 4.400004;
...
SET @rggTotalAmount_A = @rt1TotalAmount_A - @rrt1TotalAmount_B; 
SET @rggTotalAmountCash_A = @rt1AmuontCash_A - @rrt1AmuontCash_B;
...
SELECT IF(@totalAmountA = @rggTotalAmount_A , '测试成功', '测试失败') AS 'Case23.3 Testing Result';
-- 
...
SET @saleGrossMargin =  @rt1TotalAmount_A - (@rt1CommotidyNO1_A * @warehousingCommodityA_Price1) - (@rt1CommotidyNO2_A * @warehousingCommodityA_Price2) -- 
 ...
 -- 退货毛利
SET @returnGrossMargin = @rrt1TotalAmount_B - (@rrt1CommotidyNO1_A * @warehousingCommodityA_Price1) - (@rrt1CommotidyNO2_A * @warehousingCommodityA_Price2) -- 
		- (@rrt1CommotidyNO1_B * @warehousingCommodityB_Price1) - (@rrt1CommotidyNO2_B * @warehousingCommodityB_Price2);
SELECT IF(@grossMarginA = @saleGrossMargin - @returnGrossMargin, '测试成功', '测试失败') AS 'Case23.5 Testing Result';
-- 
...
SELECT IF(@totalAmountB = 0.000000, '测试成功', '测试失败') AS 'Case23.7 Testing Result';
...
SELECT IF(@grossMarginB = 0.000000, '测试成功', '测试失败') AS 'Case23.9 Testing Result';
-- 
