...
SELECT '-----------------Case5:别人退我的单，我在上班 (员工9号退8号的单，8号此时在上班)------------------' AS 'Case5';
-- 插入商品
...
SET @rt1AmuontCash_A = @rt1CommotidyNO1_A * @rt1CommotidyPrice1_A + @rt1CommotidyNO2_A * @rt1CommotidyPrice2_A + @rt1CommotidyNO3_A * @rt1CommotidyPrice3_A; -- 全部现金给
...
SET @rt2AmuontWeChat_A = @rt2CommotidyNO1_A * @rt2CommotidyPrice1_A + @rt2CommotidyNO2_A * @rt2CommotidyPrice2_A + @rt2CommotidyNO3_A * @rt2CommotidyPrice3_A; -- 全部微信给
...
SET @rrt1CommotidyPrice_A = 34.490000;
SET @rrt1AmuontCash_A = @rrt1CommotidyNO_A * @rrt1CommotidyPrice_A; -- 全部退现金
...
INSERT INTO t_retailtrade (F_VipID, F_SN, F_LocalSN, F_POS_ID, F_Logo, F_SaleDatetime, F_StaffID, F_PaymentType, F_PaymentAccount, F_Status, F_Remark, F_SourceID, F_SyncDatetime, F_Amount, F_AmountCash, F_AmountAlipay, F_AmountWeChat, F_Amount1, F_Amount2, F_Amount3, F_Amount4, F_Amount5, F_SmallSheetID, F_AliPayOrderSN, F_WxOrderSN, F_WxTradeNO, F_WxRefundNO, F_WxRefundDesc, F_WxRefundSubMchID, F_ShopID)
VALUES (1,'LS2130010100000500010001_1',11069,1,'url=ashasoadigmnalskd',@saleDatetime,@iStaffIDB,1,'0',1,'…',@rtID1_A,@syncDatetime,@rrt1TotalAmount_A,@rrt1AmuontCash_A,@rrt1AmuontWeChat_A,@rrt1AmuontAliPay_A,0.000000,0.000000,0.000000,0.000000,0.000000,1,NULL,NULL,NULL,NULL,NULL,NULL,2);
...
INSERT INTO t_retailtradecommodity (F_TradeID, F_CommodityID, F_CommodityName, F_BarcodeID, F_NO, F_PriceOriginal, F_NOCanReturn, F_PriceReturn, F_PriceSpecialOffer, F_PriceVIPOriginal)
VALUES (@rrtID1_A,@iCommodityID3,'紫云剑',247,@rrt1CommotidyNO_A,34.490000,0,@rrt1CommotidyPrice_A,NULL,34.490000);
...
VALUES (@rrtCommID1_A, @destinationCommodityID218, @rtcd1NO_A, @rtcd1WarehousingID_A);
...
SELECT IF(@iErrorCode = 0 AND @ResultVerification1 = 1,'测试成功','测试失败') AS 'Test Case5 Result';


-- 售卖总金额(店员9当天只进行退店员8的操作，故无零售记录)
