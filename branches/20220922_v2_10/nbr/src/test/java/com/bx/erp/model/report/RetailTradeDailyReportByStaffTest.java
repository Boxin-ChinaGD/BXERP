...
public class RetailTradeDailyReportByStaffTest {
	@BeforeClass
	public void setup() {
	...
	public void checkCreate() throws Exception {
		...
		RetailTradeDailyReportByStaff r = new RetailTradeDailyReportByStaff();
		...
		String saleDatetime = "1970年00月00日  00:00:00";
		r.setSaleDatetime(sdf.parse(saleDatetime));
