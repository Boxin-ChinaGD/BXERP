...
import java.util.*;
public class UTR19multiUnits2Test {
  ...
  public void uTR19multiUnits2() {
    ...
    driver.findElement(By.cssSelector(".layui-input-inline:nth-child(4) > .layui-input")).sendKeys("12");
    ...
    vars.put("multCommodityName", js.executeScript("return \"龙战于野\" + parseInt(Math.random()*100000);"));
    driver.findElement(By.cssSelector(".multiPackageCommName > td:nth-child(3) > .layui-input")).click();
    driver.findElement(By.cssSelector(".multiPackageCommName > td:nth-child(3) > .layui-input")).sendKeys(vars.get("multCommodityName").toString());
    ...
    // TODO
//      assertThat(value, is("vars.get("multCommodityName").toString()"));
    }
