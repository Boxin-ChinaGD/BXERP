...
import java.util.*;
public class UTR23queryByStaffAndTimeAndKeywordTest {
  ...
  @Test
  public void uTR23queryByStaffAndTimeAndKeyword() {
    LoginSucceed();
    ...
    driver.findElement(By.xpath("//li[contains(.,\'三个月\')]")).click();
    driver.findElement(By.name("queryKeyword")).click();
    driver.findElement(By.name("queryKeyword")).sendKeys("龙");
