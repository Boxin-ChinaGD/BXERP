...
import java.util.*;
public class UTR27queryHistorynoData2Test {
  ...
  @Test
  public void uTR27queryHistorynoData2() {
    LoginSucceed();
    ...
    driver.findElement(By.xpath("//li[contains(.,\'收银员三号\')]")).click();
    {
    ...
    {
      String value = driver.findElement(By.name("priceWholesale")).getAttribute("value");
      assertThat(value, is(" "));
    }
