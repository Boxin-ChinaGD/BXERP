...
import java.util.*;
public class UTR29queryHistoryByCommodityNameTest {
  ...
  @Test
  public void uTR29queryHistoryByCommodityName() {
    LoginSucceed();
...
//    System.out.println("商品修改记录条数为：vars.get("historyCount").toString()");
    ...
    vars.put("commodityName", js.executeScript("return \"A_B\" + parseInt(Math.random()*100000);"));
