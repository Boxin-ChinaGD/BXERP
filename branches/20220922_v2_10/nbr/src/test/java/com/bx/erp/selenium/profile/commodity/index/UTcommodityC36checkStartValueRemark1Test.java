...
import java.util.*;
public class UTcommodityC36checkStartValueRemark1Test {
  ...
  @Test
  public void uTcommodityC36checkStartValueRemark1() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("期初值备注长度[0, 50]"));
  }
}
