...
import java.util.*;
public class UTcommodityC45createCommodity8Test {
  ...
  @Test
  public void uTcommodityC45createCommodity8() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("存在相同的供应商，请修改"));
  }
}
