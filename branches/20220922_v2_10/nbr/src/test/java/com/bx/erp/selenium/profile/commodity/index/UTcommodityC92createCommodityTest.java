...
import java.util.*;
public class UTcommodityC92createCommodityTest {
  ...
  @Test
  public void uTcommodityC92createCommodity() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("增加条形码成功"));
    driver.findElement(By.cssSelector(".toAddBarcode")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-layer-content")).getText(), is("一个商品最多只能有8个条形码"));
  }
}
