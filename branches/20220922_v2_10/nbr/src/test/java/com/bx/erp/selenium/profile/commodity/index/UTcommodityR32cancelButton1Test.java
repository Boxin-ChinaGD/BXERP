...
import java.util.*;
public class UTcommodityR32cancelButton1Test {
  ...
  @Test
  public void uTcommodityR32cancelButton1() {
    LoginSucceed();
    ...
    vars.put("commodityName", driver.findElement(By.xpath("//div[@id=\'middlePart\']/div[2]/div/div[2]/table/tbody/tr/td/div/span")).getText());
    {
      String value = driver.findElement(By.name("name")).getAttribute("value");
      // TODO
//      assertThat(value, is("vars.get("commodityName").toString()"));
    }
    assertThat(driver.findElement(By.cssSelector("#commodityList + div .layui-laypage-curr em:nth-child(2)")).getText(), is("1"));
  }
}
