...
import java.util.*;
public class UTR19commodityDetails1Test {
  ...
  @Test
  public void uTR19commodityDetails1() {
    LoginSucceed();
    ...
    vars.put("barcode", driver.findElement(By.xpath("//div[@id=\'warehouseListMain\']/div[2]/div[2]/div[2]/div/div/div[2]/table/tbody/tr/td[2]/div")).getText());
    {
      String value = driver.findElement(By.name("barcodes")).getAttribute("value");
   // TODO
//      assertThat(value, is("vars.get("barcode").toString()"));
    }
    {
