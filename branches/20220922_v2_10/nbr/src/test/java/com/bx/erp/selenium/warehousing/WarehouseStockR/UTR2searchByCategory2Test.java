...
import java.util.*;
public class UTR2searchByCategory2Test {
  ...
  @Test
  public void uTR2searchByCategory2() {
    LoginSucceed();
    ...
    vars.put("countsByCategory", driver.findElement(By.cssSelector("#commodityList + div .layui-laypage-count")).getText());
    ...
    driver.findElement(By.cssSelector(".layui-nav-child:nth-child(53) a")).click();
    assertThat(driver.findElement(By.cssSelector(".layui-laypage-count")).getText(), is("vars.get(\"countsByCategory\").toString()"));
    driver.close();
  }
}
