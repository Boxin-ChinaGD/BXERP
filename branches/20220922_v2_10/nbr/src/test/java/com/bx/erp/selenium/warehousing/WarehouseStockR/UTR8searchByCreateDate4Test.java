...
import java.util.*;
public class UTR8searchByCreateDate4Test {
  ...
  @Test
  public void uTR8searchByCreateDate4() {
    LoginSucceed();
    ...
    assertThat(driver.findElement(By.xpath("//ul[@id=\'timeList\']/li[4]")).getText(), is("三个月内"));
    driver.findElement(By.xpath("//ul[@id=\'timeList\']/li[4]")).click();
