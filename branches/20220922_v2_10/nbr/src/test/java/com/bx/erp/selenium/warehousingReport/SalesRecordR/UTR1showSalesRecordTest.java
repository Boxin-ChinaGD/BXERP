...
import java.util.*;
public class UTR1showSalesRecordTest {
  ...
  @Test
  public void uTR1showSalesRecord() {
    LoginSucceed();
...
//    System.out.println("销售记录的条数为：vars.get("counts").toString()");
    vars.put("retailSheetSN", driver.findElement(By.xpath("//div[@id=\'purchasingOrderMain\']/div[2]/div/div/div[2]/table/tbody/tr/td/div")).getText());
