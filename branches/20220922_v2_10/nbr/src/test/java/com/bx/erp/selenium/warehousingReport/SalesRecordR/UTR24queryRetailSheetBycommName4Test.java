...
import java.util.*;
public class UTR24queryRetailSheetBycommName4Test {
  ...
  @Test
  public void uTR24queryRetailSheetBycommName4() {
    LoginSucceed();
...
//    System.out.println("销售记录的条数为：vars.get("counts").toString()");
    ...
    driver.findElement(By.cssSelector(".top_input")).sendKeys("不存在的商品");
