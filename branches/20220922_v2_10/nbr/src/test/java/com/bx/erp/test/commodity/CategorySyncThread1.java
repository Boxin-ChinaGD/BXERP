...
public class CategorySyncThread1 extends BaseSyncSITTestThread1 {
	 ...
	 * @param iSyncBlockNO
	 *            要同步的块的总数，即同步表主表总行数 */
	public CategorySyncThread1(MockMvc mvc, HttpSession session, int iPhase, int iPosNO, int iSyncBlockNO) {
