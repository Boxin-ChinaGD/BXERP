...
public class BaseEvent {
    ...
    public static final int EVENT_ID_ResetBaseDataActivity = EVENT_ID_SyncThread + 3;
    public static final int EVENT_ID_LoginActivity = EVENT_ID_SyncThread + 4;
    public static final int EVENT_ID_PaymentActivity = EVENT_ID_SyncThread + 5;
    public static final int EVENT_ID_PreSaleActivity = EVENT_ID_SyncThread + 6;
    public static final int EVENT_ID_PrinterActivity = EVENT_ID_SyncThread + 7;
    public static final int EVENT_ID_RetailTradeAggregationActivity = EVENT_ID_SyncThread + 8;
    public static final int EVENT_ID_RetrieveCommodityInventoryActivity = EVENT_ID_SyncThread + 9;
    public static final int EVENT_ID_SetupRightFragment = EVENT_ID_SyncThread + 10;
    public static final int EVENT_ID_SmallSheetActivity = EVENT_ID_SyncThread + 11;
    /**
     * 本Event ID只用于在SQLite中创建退货型零售单
     */
    public static final int EVENT_ID_MainActivity_CreateReturnRetailTrade = EVENT_ID_SyncThread + 12;
