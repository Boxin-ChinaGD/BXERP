...
public class Company extends BaseModel {
    ...
    @Property(nameInDb = "F_BusinessLicenseSN")
    protected String businessLicenseSN;

    @Property(nameInDb = "F_BusinessLicensePicture")
    protected String businessLicensePicture;

    @NotNull
    @Property(nameInDb = "F_BossName")
    protected String bossName;

    @NotNull
    @Property(nameInDb = "F_BossPhone")
    protected String bossPhone;

    @NotNull
    @Property(nameInDb = "F_BossPassword")
    protected String bossPassword;

    @NotNull
    @Property(nameInDb = "F_BossWechat")
    protected String bossWechat;

    @NotNull
    @Property(nameInDb = "F_DBName")
    protected String dbName;

    @NotNull
    @Property(nameInDb = "F_Key")
    protected String key;

    @Property(nameInDb = "F_Submchid")
    ...
    @Property(nameInDb = "F_DBUserName")
    protected String dbUserName;

    @Property(nameInDb = "F_DBUserPassword")
    protected String dbUserPassword;

    @Property(nameInDb = "F_BrandName")
    protected String brandName;

    @Property(nameInDb = "F_Logo")
    protected String logo;

    @Generated(hash = 2001601826)
    public Company(Long ID, @NotNull String name, @NotNull String SN, int status, String businessLicenseSN, String businessLicensePicture, @NotNull String bossName, @NotNull String bossPhone, @NotNull String bossPassword,
            @NotNull String bossWechat, @NotNull String dbName, @NotNull String key, String submchid, @NotNull Date expireDatetime, @NotNull Date createDatetime, @NotNull Date updateDatetime, String dbUserName,
            String dbUserPassword, String brandName, String logo) {
        this.ID = ID;
        this.name = name;
        this.SN = SN;
        this.status = status;
    ...
    public String toString() {
        return "Company{" +
                ...
                ", SN='" + SN + '\'' +
                ", status=" + status +
                ", businessLicenseSN='" + businessLicenseSN + '\'' +
    ...
    public BaseModel doParse1(JSONObject jo) {
        ...
        try {
            ID = Long.valueOf(jo.getInt(field.getFIELD_NAME_ID()));
