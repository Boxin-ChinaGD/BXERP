...
@Entity(nameInDb = "smallSheetFrame")
public class SmallSheetFrame extends BaseModel {
    ...
    @Property(nameInDb = "F_CountOfBlankLineAtBottom")
    protected int countOfBlankLineAtBottom;

    @Property(nameInDb = "F_DelimiterToRepeat")
    ...
    public static final String HTTP_REQ_URL_CreateC = "smallSheetFrame/createEx.bx";
    public static final String HTTP_REQ_URL_UpdateC = "smallSheetFrame/updateEx.bx";
    //    public static final String HTTP_REQ_URL_RetrieveN = "smallSheetSync/retrieveNEx.bx";
    ...
    public static final String HTTP_REQ_URL_DeleteC = "smallSheetFrame/deleteEx.bx?ID=";
    public static final String smallSheetfeedbackURL_FRONT = "smallSheetSync/feedbackEx.bx?sID="; //...
    ...
    public static final String FIELD_ERROR_SmallSheetTextNO = "小票格式的从表总数必须等于" + NO_SmallSheetTextItem;

    public SmallSheetFrame(Long ID, String logo, List<SmallSheetText> textList, List<String[]> listComm) {
        this.ID = ID;
        this.logo = logo;
    ...
    @Generated(hash = 500440497)
    public SmallSheetFrame(Long ID, String logo, int countOfBlankLineAtBottom, String delimiterToRepeat, Date syncDatetime, Date createDatetime, Date updateDatetime, String syncType, int SlaveCreated) {
        this.ID = ID;
        this.logo = logo;
    ...
    public BaseModel doParse1(JSONObject object) {
        ...
        try {
            ...
            countOfBlankLineAtBottom = object.getInt(field.getFIELD_NAME_countOfBlankLineAtBottom());
    ...
    public BaseModel parse1(String s) {
        ...
        try {
            JSONObject joSSF = new JSONObject(s);
    ...
    public List<BaseModel> parseN(String s) {
        ...
        List<BaseModel> smallSheetFrameList = new ArrayList<>();
        try {
            JSONArray jaSSF = new JSONArray(s);
            for (int i = 0; i < jaSSF.length(); i++) {
...
//                ", listCommodity=" + listCommodity +
    ...
    public String checkCreate(int iUseCaseID) {
        ...
        if (printCheckField(field.getFIELD_NAME_listSlave1(), FIELD_ERROR_SmallSheetTextNO, sbError) && listSlave1 != null && listSlave1.size() != NO_SmallSheetTextItem) {
            return sbError.toString();
        }
    ...
    public String checkUpdate(int iUseCaseID) {
        ...
        if (listSlave1 != null || listSlave1.size() != 0) {
            for (int i = 0; i < listSlave1.size(); i++) {
                SmallSheetText sheetText = (SmallSheetText) listSlave1.get(i);
                if (!sheetText.getFrameId().equals(ID)) {
